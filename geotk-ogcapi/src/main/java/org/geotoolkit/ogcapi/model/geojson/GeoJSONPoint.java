 ...
 */
@JsonPropertyOrder({
    GeoJSONPoint.JSON_PROPERTY_TYPE,
    GeoJSONPoint.JSON_PROPERTY_COORDINATES,
    GeoJSONPoint.JSON_PROPERTY_BBOX
})
@XmlRootElement(name = "GeoJSONPoint")
@XmlAccessorType(XmlAccessType.FIELD)
@JacksonXmlRootElement(localName = "GeoJSONPoint")
public class GeoJSONPoint extends DataTransferObject {
    ...
    public GeoJSONPoint type(@jakarta.annotation.Nonnull TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GeoJSONPoint coordinates(@jakarta.annotation.Nonnull List<BigDecimal> coordinates) {
    ...
    public GeoJSONPoint bbox(@jakarta.annotation.Nullable List<BigDecimal> bbox) {
        this.bbox = bbox;
        return this;
    }
