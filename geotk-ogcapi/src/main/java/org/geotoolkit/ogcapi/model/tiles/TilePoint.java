 ...
 */
@JsonPropertyOrder({
    TilePoint.JSON_PROPERTY_COORDINATES,
    TilePoint.JSON_PROPERTY_CRS,
    TilePoint.JSON_PROPERTY_TILE_MATRIX,
    TilePoint.JSON_PROPERTY_SCALE_DENOMINATOR,
    TilePoint.JSON_PROPERTY_CELL_SIZE
})
@XmlRootElement(name = "TilePoint")
@XmlAccessorType(XmlAccessType.FIELD)
@JacksonXmlRootElement(localName = "TilePoint")
public final class TilePoint extends DataTransferObject {
    ...
    public TilePoint coordinates(@jakarta.annotation.Nonnull List<BigDecimal> coordinates) {
    ...
    public TilePoint crs(@jakarta.annotation.Nullable Crs crs) {
        this.crs = crs;
        return this;
    }
    ...
    public TilePoint tileMatrix(@jakarta.annotation.Nullable String tileMatrix) {
    ...
    public TilePoint scaleDenominator(@jakarta.annotation.Nullable BigDecimal scaleDenominator) {
    ...
    public TilePoint cellSize(@jakarta.annotation.Nullable BigDecimal cellSize) {
    ...
    /**
     * Return true if this tilePoint object is equal to o.
     */
    @Override
