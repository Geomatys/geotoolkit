 ...
 */
@JsonPropertyOrder({
    GeoJSONMultiPoint.JSON_PROPERTY_TYPE,
    GeoJSONMultiPoint.JSON_PROPERTY_COORDINATES,
    GeoJSONMultiPoint.JSON_PROPERTY_BBOX
})
@XmlRootElement(name = "GeoJSONMultiPoint")
@XmlAccessorType(XmlAccessType.FIELD)
@JacksonXmlRootElement(localName = "GeoJSONMultiPoint")
public class GeoJSONMultiPoint extends DataTransferObject {
    ...
    public enum TypeEnum {
        ...
        MULTI_POINT(String.valueOf("MultiPoint"));
    ...
    public GeoJSONMultiPoint type(@jakarta.annotation.Nonnull TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GeoJSONMultiPoint coordinates(@jakarta.annotation.Nonnull List<List<BigDecimal>> coordinates) {
    ...
    public GeoJSONMultiPoint bbox(@jakarta.annotation.Nullable List<BigDecimal> bbox) {
        this.bbox = bbox;
        return this;
    }
    ...
    /**
     * Return true if this GeoJSON_MultiPoint object is equal to o.
     */
    @Override
