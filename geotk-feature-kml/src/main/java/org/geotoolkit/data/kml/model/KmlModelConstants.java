...
public final class KmlModelConstants {
    ...
    static {
        ...
        //-------------------- GENERIC KML ENTITY ------------------------------
        ftb = new FeatureTypeBuilder().setNameSpace(KML_NAMESPACE).setDefaultMultiplicity(0, 1);
        ...
        //-------------------- FOLDER ------------------------------
        ftb = new FeatureTypeBuilder().setNameSpace(KML_NAMESPACE).setDefaultMultiplicity(0, Integer.MAX_VALUE);
