...
public class PersonType {
    ...
    public PersonType(String name, String email, String uri) {
        ObjectFactory factory = new ObjectFactory();
        this.nameOrUriOrEmail = new ArrayList<>();
        if (name != null) {
            this.nameOrUriOrEmail.add(factory.createPersonTypeName(name));
        }
        if (email != null) {
            this.nameOrUriOrEmail.add(factory.createPersonTypeEmail(email));
        }
        if (uri != null) {
            this.nameOrUriOrEmail.add(factory.createPersonTypeUri(new UriType(uri)));
        }
    }
