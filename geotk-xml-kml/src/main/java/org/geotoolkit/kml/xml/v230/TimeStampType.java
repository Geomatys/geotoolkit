...
@XmlType(name = "TimeStampType", namespace = "http://www.opengis.net/kml/2.2", propOrder = {
    "when",
    ...
    extends AbstractTimePrimitiveType
{
    ...
    @XmlElement(name = "TimeStampSimpleExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
    protected List<Object> timeStampSimpleExtensionGroup;
    @XmlElement(name = "TimeStampObjectExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
