...
@XmlType(name = "BoundaryType", namespace = "http://www.opengis.net/kml/2.2", propOrder = {
    "linearRing",
...
public class BoundaryType {
    ...
    @XmlElement(name = "LinearRing", namespace = "http://www.opengis.net/kml/2.2")
    protected LinearRingType linearRing;
    @XmlElement(name = "BoundarySimpleExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
    protected List<Object> boundarySimpleExtensionGroup;
    @XmlElement(name = "BoundaryObjectExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
