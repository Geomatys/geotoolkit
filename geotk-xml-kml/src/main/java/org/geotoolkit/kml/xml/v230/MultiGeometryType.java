...
@XmlType(name = "MultiGeometryType", namespace = "http://www.opengis.net/kml/2.2", propOrder = {
    ...
    extends AbstractGeometryType
{
    ...
    @XmlElement(name = "MultiGeometrySimpleExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
    protected List<Object> multiGeometrySimpleExtensionGroup;
    @XmlElement(name = "MultiGeometryObjectExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
