...
@XmlType(name = "ExtendedDataType", namespace = "http://www.opengis.net/kml/2.2", propOrder = {
    "data",
    "schemaData",
    "any"
})
public class ExtendedDataType {
    ...
    @XmlElement(name = "Data", namespace = "http://www.opengis.net/kml/2.2")
    protected List<DataType> data;
    @XmlElement(name = "SchemaData", namespace = "http://www.opengis.net/kml/2.2")
