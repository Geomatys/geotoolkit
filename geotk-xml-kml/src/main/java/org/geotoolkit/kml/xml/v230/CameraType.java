...
@XmlType(name = "CameraType", namespace = "http://www.opengis.net/kml/2.2", propOrder = {
    "longitude",
    "latitude",
    "altitude",
    "heading",
    ...
    extends AbstractViewType
{
    ...
    @XmlElement(name = "CameraSimpleExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
    protected List<Object> cameraSimpleExtensionGroup;
    @XmlElement(name = "CameraObjectExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
