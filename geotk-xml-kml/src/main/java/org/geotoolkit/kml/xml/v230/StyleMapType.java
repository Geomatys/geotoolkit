...
@XmlType(name = "StyleMapType", namespace = "http://www.opengis.net/kml/2.2", propOrder = {
    "pair",
    ...
    extends AbstractStyleSelectorType
{
    ...
    @XmlElement(name = "Pair", namespace = "http://www.opengis.net/kml/2.2")
    protected List<PairType> pair;
    @XmlElement(name = "StyleMapSimpleExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
    protected List<Object> styleMapSimpleExtensionGroup;
    @XmlElement(name = "StyleMapObjectExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
