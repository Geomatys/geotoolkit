...
@XmlType(name = "LinearRingType", namespace = "http://www.opengis.net/kml/2.2", propOrder = {
    "extrude",
    "tessellate",
    "altitudeMode",
    ...
    extends AbstractGeometryType
{
    ...
    @XmlElement(name = "LinearRingSimpleExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
    protected List<Object> linearRingSimpleExtensionGroup;
    @XmlElement(name = "LinearRingObjectExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
