...
@XmlType(name = "SimpleFieldType", namespace = "http://www.opengis.net/kml/2.2", propOrder = {
    "displayName",
...
public class SimpleFieldType {
    ...
    @XmlElement(name = "SimpleFieldExtension", namespace = "http://www.opengis.net/kml/2.2")
