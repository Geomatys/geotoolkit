...
@XmlType(name = "AliasType", namespace = "http://www.opengis.net/kml/2.2", propOrder = {
    "targetHref",
    "sourceHref",
    ...
    extends AbstractObjectType
{
    ...
    @XmlElement(name = "AliasSimpleExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
    protected List<Object> aliasSimpleExtensionGroup;
    @XmlElement(name = "AliasObjectExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
