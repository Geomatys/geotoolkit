...
@XmlType(name = "ResourceMapType", namespace = "http://www.opengis.net/kml/2.2", propOrder = {
    "alias",
    ...
    extends AbstractObjectType
{
    ...
    @XmlElement(name = "Alias", namespace = "http://www.opengis.net/kml/2.2")
    protected List<AliasType> alias;
    @XmlElement(name = "ResourceMapSimpleExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
    protected List<Object> resourceMapSimpleExtensionGroup;
    @XmlElement(name = "ResourceMapObjectExtensionGroup", namespace = "http://www.opengis.net/kml/2.2")
