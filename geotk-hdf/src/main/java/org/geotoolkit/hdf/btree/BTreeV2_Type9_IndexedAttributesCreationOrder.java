 ...
 */
public final class BTreeV2_Type9_IndexedAttributesCreationOrder {

    /**
     * This is an 8-byte sequence of bytes and is the heap ID for the attribute
     * in the object’s attribute fractal heap.
     */
    private byte[] heapId;
    /**
