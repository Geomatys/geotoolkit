 ...
 * ThingsResponse
 */
public class ThingsResponse implements STSPagedResponse {

    @JsonProperty("@iot.count")
    private BigDecimal iotCount = null;

    private List<Thing> value = null;

    @JsonProperty("@iot.nextLink")
    private String iotNextLink = null;

    public ThingsResponse iotCount(BigDecimal iotCount) {
  ...
  *
    ...
    public ThingsResponse value(List<Thing> value) {
        this.value = value;
        return this;
    }

    public ThingsResponse addValueItem(Thing valueItem) {
    ...
    public ThingsResponse iotNextLink(String iotNextLink) {
  ...
  *
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ThingsResponse thingsResponse = (ThingsResponse) o;
        return Objects.equals(this.iotCount, thingsResponse.iotCount)
                && Objects.equals(this.value, thingsResponse.value)
                && Objects.equals(this.iotNextLink, thingsResponse.iotNextLink);
    }
    ...
    public String toString() {
        ...
        sb.append("class ThingsResponse {\n");
