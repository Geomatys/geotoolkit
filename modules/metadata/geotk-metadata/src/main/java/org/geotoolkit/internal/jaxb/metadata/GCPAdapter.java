 ...
 * @module
 */
public final class GCPAdapter extends MetadataAdapter<GCPAdapter,GCP> {
    /**
     ...
     */
    private GCPAdapter(final GCP metadata) {
        super(metadata);
    }
     ...
     */
    @Override
    protected GCPAdapter wrap(final GCP value) {
        return new GCPAdapter(value);
    }
