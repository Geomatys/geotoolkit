 ...
 * @module
 */
public final class ObjectiveTypeAdapter extends CodeListAdapter<ObjectiveTypeAdapter, ObjectiveType> {
    /**
     ...
     */
    public ObjectiveTypeAdapter() {
    }

    /**
     * Creates a new adapter for the given proxy.
     */
    private ObjectiveTypeAdapter(final CodeListProxy proxy) {
        super(proxy);
    }
     ...
     */
    @Override
    protected ObjectiveTypeAdapter wrap(CodeListProxy proxy) {
        return new ObjectiveTypeAdapter(proxy);
    }
