 ...
 * @module
 */
public class GeometryAdapter extends XmlAdapter<GeometryAdapter,Geometry> {
    /**
     ...
     */
    @Override
    public final Geometry unmarshal(final GeometryAdapter value) {
     ...
     */
    @Override
    public final GeometryAdapter marshal(final Geometry value) {
        if (value == null) {
            return null;
        }
        return wrap(value);
