 ...
 * to give them the {@code "gmi"} namespace. This is required for XML (un)marshaling
 ...
 * the {@link org.geotoolkit.metadata.iso} package. When marshaling, the adapters will
