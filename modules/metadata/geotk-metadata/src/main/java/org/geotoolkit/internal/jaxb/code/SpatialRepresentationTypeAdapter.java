 ...
 * @module
 */
public final class SpatialRepresentationTypeAdapter
        extends CodeListAdapter<SpatialRepresentationTypeAdapter, SpatialRepresentationType>
{
     ...
     */
    public SpatialRepresentationTypeAdapter() {
    }

    /**
     * Creates a new adapter for the given proxy.
     */
    private SpatialRepresentationTypeAdapter(final CodeListProxy proxy) {
        super(proxy);
    }
