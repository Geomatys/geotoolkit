...
public final class TopologyLevelAdapter extends CodeListAdapter<TopologyLevelAdapter, TopologyLevel> {
     ...
     */
    public TopologyLevelAdapter() {
    }

    /**
     * Creates a new adapter for the given proxy.
     */
    private TopologyLevelAdapter(final CodeListProxy proxy) {
        super(proxy);
    }
     ...
     */
    @Override
    protected TopologyLevelAdapter wrap(CodeListProxy proxy) {
        return new TopologyLevelAdapter(proxy);
    }
