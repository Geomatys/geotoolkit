...
public class DefaultRangeDimension extends MetadataEntity implements RangeDimension {
     ...
     * then this method delegates to the corresponding {@code wrap} static method.
     *
     ...
     * @since 3.18
     */
    public static DefaultRangeDimension wrap(final RangeDimension object) {
        if (object instanceof Band) {
            return DefaultBand.wrap((Band) object);
        }
