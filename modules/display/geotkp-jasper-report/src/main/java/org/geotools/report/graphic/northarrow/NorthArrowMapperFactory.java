...
package org.geotools.report.graphic.northarrow;
...
public class NorthArrowMapperFactory implements JRMapperFactory<JRRenderable,MapContext>{
    ...
    private static final ImageIcon ICON = new ImageIcon(NorthArrowMapperFactory.class.getResource("/org/geotools/report/boussole.png"));
