...
public class JFillMarkPane extends StyleElementEditor<Mark> {
    ...
    /**
     * {@inheritDoc }
     * This method parses the settled object. If none color can be extracted, we select red color by default.
     */
    @Override
    ...
    /**
     * {@inheritDoc }
     * This funtion creates a Mark object from the selection. 
     * In the graphic interface, the opacity is given between 0 and 100 but in the object, we have to fill it with value between 0 and 1.
     * If no mark is selected, we return mark square with default stroke and color.
     */
    @Override
    public Mark create() {
    ...
    private void initComponents() {
        ...
        guiMarkColorChooser = new org.geotoolkit.gui.swing.style.JColorPane();

        setLayout(new java.awt.BorderLayout());

        guiMarkColorChooser.setBorder(javax.swing.BorderFactory.createTitledBorder("Couleur"));
        add(guiMarkColorChooser, java.awt.BorderLayout.CENTER);
    }// </editor-fold>//GEN-END:initComponents

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private org.geotoolkit.gui.swing.style.JColorPane guiMarkColorChooser;
