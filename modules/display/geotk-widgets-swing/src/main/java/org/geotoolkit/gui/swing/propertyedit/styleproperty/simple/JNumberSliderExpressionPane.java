...
public class JNumberSliderExpressionPane extends StyleElementEditor<Expression>{
    ...
    private void initComponents() {
        ...
        Binding binding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, guiSlider, ELProperty.create("${value}"), guiNumber, BeanProperty.create("value"));
        ...
        binding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, guiNumber, ELProperty.create("${value}"), guiSlider, BeanProperty.create("value"));
        bindingGroup.addBinding(binding);
