...
public class JRasterSymbolizerPane extends StyleElementEditor<RasterSymbolizer> {
    ...
    public JRasterSymbolizerPane() {
        ...
        guiRelief.setExpressionUnvisible();
        guiContrast.setExpressionUnvisible();
    }
...
//        }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.linkSize(SwingConstants.HORIZONTAL, new Component[] {butChannels, guiOverLap});
