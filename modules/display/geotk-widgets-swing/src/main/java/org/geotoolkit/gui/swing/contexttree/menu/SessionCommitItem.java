...
public class SessionCommitItem extends AbstractTreePopupItem{
    ...
    private final SessionCommitAction action;

    /**
     * Session commit for jcontexttree
     */
    public SessionCommitItem(){
        super(new SessionCommitAction());
        action = (SessionCommitAction) getAction();
    }
