 ...
 * @module pending
 */
public class AnyTypeDelegate extends AbstractEditionDelegate {
    ...
    public AnyTypeDelegate(final DefaultEditionHandler handler) {
        super(handler);
    }
            ...
            switch(currentAction){
                ...
                case NODE_ADD :
                    if(geometry == null){
                        ...
                        MultiPolygon result = (MultiPolygon) handler.getHelper().insertNode(geometry, e.getX(), e.getY());
                ...
                case NODE_DELETE :
                    if(geometry == null){
                        ...
                        MultiPolygon result = (MultiPolygon) handler.getHelper().deleteNode(geometry, e.getX(), e.getY());
                        if(result != null){
                            modified = modified || result != geometry;
                            geometry = result;
                            handler.getDecoration().setGeometries(Collections.singleton(geometry));
                ...
                case SUB_DELETE :
                    if(geometry == null){
                        ...
                        MultiPolygon result = (MultiPolygon) handler.getHelper().deleteSubGeometry(geometry, e.getX(), e.getY());
                        if(result != null){
                            modified = modified || result != geometry;
                            geometry = result;
                            handler.getDecoration().setGeometries(Collections.singleton(geometry));
