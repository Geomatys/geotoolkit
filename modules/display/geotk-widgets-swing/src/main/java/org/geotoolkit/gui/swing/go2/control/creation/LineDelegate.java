            ...
            switch(currentAction){
                ...
                case NODE_ADD :
                    if(geometry == null){
                        ...
                        LineString result = (LineString) handler.getHelper().insertNode(geometry, e.getX(), e.getY());
                ...
                case NODE_DELETE :
                    if(geometry == null){
                        ...
                        LineString result = (LineString) handler.getHelper().deleteNode(geometry, e.getX(), e.getY());
                        if(result != null){
                            modified = modified || result != geometry;
                            geometry = result;
                            handler.getDecoration().setGeometries(Collections.singleton(geometry));
