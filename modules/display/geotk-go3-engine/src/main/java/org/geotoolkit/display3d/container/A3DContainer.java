...
//        light.setDiffuse(new ColorRGBA(0.75f, 0.75f, 0.75f, 0.75f));
//        light.setAmbient(new ColorRGBA(0.5f, 0.5f, 0.5f, 0.8f));
//        light.setEnabled(true);
...
//        Box box = new Box("mybox", new Vector3(-1, -1, -1), new Vector3(5, 5, 5));
//
//        root.attachChild(box);

        contextNode = new ContextNode(canvas, context);
//        contextNode.setTranslation(0, 1, 0);
//        contextNode.setScale(0.1f);
        root.attachChild(contextNode);
//        root.markDirty(DirtyType.Attached);
    }
...
//        System.out.println(camera.getLocation());
        ...
        skybox.updateGeometricState(0.0f, b);
    ...
    private Node buildPlan(){
        ...
        back.initialize(10000, 10000);
        back.setDefaultColor(ColorRGBA.WHITE);
    ...
    private Skybox buildSkyBox() {
        ...
        final Texture north = TextureManager.load(
                A3DContainer.class.getResource(dir + "1.jpg"),
        ...
        final Texture south = TextureManager.load(
                A3DContainer.class.getResource(dir + "3.jpg"),
                Texture.MinificationFilter.BilinearNearestMipMap, Image.Format.GuessNoCompression, true);
        final Texture east = TextureManager.load(
                A3DContainer.class.getResource(dir + "2.jpg"),
                Texture.MinificationFilter.BilinearNearestMipMap, Image.Format.GuessNoCompression, true);
        final Texture west = TextureManager.load(
                A3DContainer.class.getResource(dir + "4.jpg"),
                Texture.MinificationFilter.BilinearNearestMipMap, Image.Format.GuessNoCompression, true);
        final Texture up = TextureManager.load(
                A3DContainer.class.getResource(dir + "6.jpg"),
                Texture.MinificationFilter.BilinearNearestMipMap, Image.Format.GuessNoCompression, true);
        final Texture down = TextureManager.load(
                A3DContainer.class.getResource(dir + "5.jpg"),
                Texture.MinificationFilter.BilinearNearestMipMap, Image.Format.GuessNoCompression, true);
