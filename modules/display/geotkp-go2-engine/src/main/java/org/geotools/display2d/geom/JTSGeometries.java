 ...
 */
package org.geotools.display2d.geom;
...
import org.geotools.display2d.array.JTSArray;
 ...
 */
public class JTSGeometries extends org.geotools.display2d.geom.GeometryCollection {
    /**
...
//      final int id = geometry.getSRID();
     ...
     */
    private org.geotools.display2d.geom.Geometry addSF(final Point geometry)
            throws TransformException
    {
        Coordinate coord = geometry.getCoordinate();
        return add(new org.geotools.display2d.geom.Point(coord, getCoordinateReferenceSystem(geometry)));
    }
     ...
     *         be transformed in this collection's coordinate system.
     */
    private org.geotools.display2d.geom.Geometry addSF(final LineString geometry)
            throws TransformException
    {
     ...
     *         be transformed in this collection's coordinate system.
     */
    private org.geotools.display2d.geom.Geometry addSF(final Polygon geometry)
            throws TransformException
    {
        final org.geotools.display2d.geom.Polygon polygon =
                new org.geotools.display2d.geom.Polygon(toPolyline(geometry.getExteriorRing()));
     ...
     *         be transformed in this collection's coordinate system.
     */
    private org.geotools.display2d.geom.Geometry addSF(final GeometryCollection geometry)
            throws TransformException
    {
     ...
     */
    public org.geotools.display2d.geom.Geometry add(final Geometry geometry)
