...
import org.geotoolkit.internal.jaxb.v110.ogc.AbstractIdType;
import org.geotoolkit.internal.jaxb.v110.ogc.BinaryOperatorType;
import org.geotoolkit.internal.jaxb.v110.ogc.FeatureIdType;
...
public class OGC110toGTTransformer {
     ...
     */
    public Filter visitFilter(org.geotoolkit.internal.jaxb.v110.ogc.FilterType ft){
        if(ft == null)return null;        
        
        if(ft.getComparisonOps() != null){
            final JAXBElement<? extends org.geotoolkit.internal.jaxb.v110.ogc.ComparisonOpsType> jax = ft.getComparisonOps();
            return visitComparisonOp(jax);     
        }else if(ft.getLogicOps() != null){
            final JAXBElement<? extends org.geotoolkit.internal.jaxb.v110.ogc.LogicOpsType> jax = ft.getLogicOps();
            return visitLogicOp(jax);
        }else if(ft.getSpatialOps() != null){
            final JAXBElement<? extends org.geotoolkit.internal.jaxb.v110.ogc.SpatialOpsType> jax = ft.getSpatialOps();
     ...
     */
    public Filter visitSpatialOp(final JAXBElement<? extends org.geotoolkit.internal.jaxb.v110.ogc.SpatialOpsType> jax) {
        final org.geotoolkit.internal.jaxb.v110.ogc.SpatialOpsType ops = jax.getValue();
        final String OpName = jax.getName().getLocalPart();

        if (ops instanceof org.geotoolkit.internal.jaxb.v110.ogc.BinarySpatialOpType) {
            org.geotoolkit.internal.jaxb.v110.ogc.BinarySpatialOpType binary = (org.geotoolkit.internal.jaxb.v110.ogc.BinarySpatialOpType) ops;
            JAXBElement<? extends AbstractGeometryType> geom = binary.getAbstractGeometry();
            org.geotoolkit.internal.jaxb.v110.ogc.PropertyNameType pnt = binary.getPropertyName();
        ...
        } else if (ops instanceof org.geotoolkit.internal.jaxb.v110.ogc.DistanceBufferType) {
            org.geotoolkit.internal.jaxb.v110.ogc.DistanceBufferType dstOp = (org.geotoolkit.internal.jaxb.v110.ogc.DistanceBufferType) ops;
            org.geotoolkit.internal.jaxb.v110.ogc.DistanceType dt = dstOp.getDistance();
            JAXBElement<? extends org.geotoolkit.internal.jaxb.v110.gml.AbstractGeometryType> geom = dstOp.getAbstractGeometry();
            org.geotoolkit.internal.jaxb.v110.ogc.PropertyNameType pnt = dstOp.getPropertyName();
        ...
        } else if (ops instanceof org.geotoolkit.internal.jaxb.v110.ogc.BBOXType) {
            org.geotoolkit.internal.jaxb.v110.ogc.BBOXType binary = (org.geotoolkit.internal.jaxb.v110.ogc.BBOXType) ops;
     ...
     */
    public Filter visitLogicOp(final JAXBElement<? extends org.geotoolkit.internal.jaxb.v110.ogc.LogicOpsType> jax) {
        final org.geotoolkit.internal.jaxb.v110.ogc.LogicOpsType ops = jax.getValue();
        final String OpName = jax.getName().getLocalPart();

        if (ops instanceof org.geotoolkit.internal.jaxb.v110.ogc.UnaryLogicOpType) {
            org.geotoolkit.internal.jaxb.v110.ogc.UnaryLogicOpType unary = (org.geotoolkit.internal.jaxb.v110.ogc.UnaryLogicOpType) ops;
        ...
        } else if (ops instanceof org.geotoolkit.internal.jaxb.v110.ogc.BinaryLogicOpType) {
            org.geotoolkit.internal.jaxb.v110.ogc.BinaryLogicOpType binary = (org.geotoolkit.internal.jaxb.v110.ogc.BinaryLogicOpType) ops;
            ...
            if (JAXBStatics.FILTER_LOGIC_AND.equalsIgnoreCase(OpName)) {
                ...
                for(JAXBElement<?> ele : binary.getComparisonOpsOrSpatialOpsOrLogicOps()){
                    ...
                    if(obj instanceof org.geotoolkit.internal.jaxb.v110.ogc.ComparisonOpsType){
                        filters.add(visitComparisonOp( (JAXBElement<? extends org.geotoolkit.internal.jaxb.v110.ogc.ComparisonOpsType>) ele ));
                    }else if(obj instanceof org.geotoolkit.internal.jaxb.v110.ogc.SpatialOpsType){
                        filters.add(visitSpatialOp( (JAXBElement<? extends org.geotoolkit.internal.jaxb.v110.ogc.SpatialOpsType>) ele ));
                    }else if(obj instanceof org.geotoolkit.internal.jaxb.v110.ogc.LogicOpsType){
                        filters.add(visitLogicOp( (JAXBElement<? extends org.geotoolkit.internal.jaxb.v110.ogc.LogicOpsType>) ele ));
                    }
                }
     ...
     */
    public Filter visitComparisonOp(final JAXBElement<? extends org.geotoolkit.internal.jaxb.v110.ogc.ComparisonOpsType> jax){
        final org.geotoolkit.internal.jaxb.v110.ogc.ComparisonOpsType ops = jax.getValue();
        final String OpName = jax.getName().getLocalPart();

        if (ops instanceof org.geotoolkit.internal.jaxb.v110.ogc.BinaryComparisonOpType) {
            org.geotoolkit.internal.jaxb.v110.ogc.BinaryComparisonOpType binary = (org.geotoolkit.internal.jaxb.v110.ogc.BinaryComparisonOpType) ops;
        ...
        } else if (ops instanceof org.geotoolkit.internal.jaxb.v110.ogc.PropertyIsLikeType) {
            org.geotoolkit.internal.jaxb.v110.ogc.PropertyIsLikeType property = (org.geotoolkit.internal.jaxb.v110.ogc.PropertyIsLikeType) ops;
        ...
        } else if (ops instanceof org.geotoolkit.internal.jaxb.v110.ogc.PropertyIsBetweenType) {
            org.geotoolkit.internal.jaxb.v110.ogc.PropertyIsBetweenType property = (org.geotoolkit.internal.jaxb.v110.ogc.PropertyIsBetweenType) ops;
        ...
        } else if (ops instanceof org.geotoolkit.internal.jaxb.v110.ogc.PropertyIsNullType) {
            org.geotoolkit.internal.jaxb.v110.ogc.PropertyIsNullType property = (org.geotoolkit.internal.jaxb.v110.ogc.PropertyIsNullType) ops;
     ...
     */
    public Filter visitIds(List<JAXBElement<? extends org.geotoolkit.internal.jaxb.v110.ogc.AbstractIdType>> lst){
        Set<Identifier> ids = new HashSet<Identifier>();
        
        for(JAXBElement<? extends org.geotoolkit.internal.jaxb.v110.ogc.AbstractIdType> id : lst){
    ...
    public Expression visit(JAXBElement<? extends org.geotoolkit.internal.jaxb.v110.gml.AbstractGeometryType> ele){
