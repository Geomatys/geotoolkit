...
public final class FXZoomToAction extends FXMapAction {
    ...
    public FXZoomToAction(FXMap map) {
        super(map,GeotkFX.getString(FXZoomToAction.class,"zoom_at"),GeotkFX.getString(FXZoomToAction.class,"zoom_at"),GeotkFX.createGlyph(FontAwesome.Glyph.MAP_MARKER));
    }
