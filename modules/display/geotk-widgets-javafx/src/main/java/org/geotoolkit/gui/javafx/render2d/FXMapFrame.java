...
import org.geotoolkit.gui.javafx.contexttree.menu.CopyStyleItem;
import org.geotoolkit.gui.javafx.contexttree.menu.DeleteItem;
import org.geotoolkit.gui.javafx.contexttree.menu.ExportCoverageItem;
import org.geotoolkit.gui.javafx.contexttree.menu.ExportFeatureSetItem;
...
import org.geotoolkit.gui.javafx.contexttree.menu.PasteStyleItem;
...
public class FXMapFrame extends BorderPane {
    ...
    public FXMapFrame(MapContext context, Hints hints){
        ...
        tree.getMenuItems().add(new ExportFeatureSetItem());
        tree.getMenuItems().add(new ExportCoverageItem());
        final CopyStyleItem copyItem = new CopyStyleItem();
        tree.getMenuItems().add(copyItem);
        tree.getMenuItems().add(new PasteStyleItem(copyItem));
        tree.getMenuItems().add(new SeparatorMenuItem());
