...
import org.geotoolkit.legacy.array.JTSArray;
...
//      final int id = geometry.getSRID();
     ...
     */
    private org.geotoolkit.legacy.geom.Geometry addSF(final Point geometry)
            throws TransformException
    {
        Coordinate coord = geometry.getCoordinate();
        return add(new org.geotoolkit.legacy.geom.Point(coord, getCoordinateReferenceSystem(geometry)));
    }
     ...
     *         be transformed in this collection's coordinate system.
     */
    private org.geotoolkit.legacy.geom.Geometry addSF(final LineString geometry)
            throws TransformException
    {
     ...
     *         be transformed in this collection's coordinate system.
     */
    private org.geotoolkit.legacy.geom.Geometry addSF(final Polygon geometry)
            throws TransformException
    {
        final org.geotoolkit.legacy.geom.Polygon polygon =
                new org.geotoolkit.legacy.geom.Polygon(toPolyline(geometry.getExteriorRing()));
     ...
     *         be transformed in this collection's coordinate system.
     */
    private org.geotoolkit.legacy.geom.Geometry addSF(final GeometryCollection geometry)
            throws TransformException
    {
     ...
     */
    public org.geotoolkit.legacy.geom.Geometry add(final Geometry geometry)
