 ...
 *
 * @source $URL: http://svn.geotools.org/branches/legacy/migrate/src/org/geotools/renderer/geom/GeometryCollection.java $
            ...
            throws TransformException, UnmodifiableGeometryException
    {
        ...
        for (int i=0; i<count; i++) {
            ...
            try {
                ...
                Logger.getLogger(GeometryCollection.class.getName()).log(Level.SEVERE, null, ex);
            }
