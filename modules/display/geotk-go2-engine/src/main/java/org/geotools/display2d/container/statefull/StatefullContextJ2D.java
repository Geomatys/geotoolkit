 ...
 */
package org.geotools.display2d.container.statefull;
...
import org.geotools.display2d.container.MultiThreadedRendering;
import org.geotools.display2d.container.stateless.StatelessCoverageLayerJ2D;
import org.geotools.display2d.container.stateless.StatelessDynamicLayerJ2D;
...
public class StatefullContextJ2D extends GraphicJ2D{
    ...
    public StatefullContextJ2D(final ReferencedCanvas2D canvas, final MapContext context) {
        ...
        try {
            ...
            Logger.getLogger(StatefullContextJ2D.class.getName()).log(Level.SEVERE, null, ex);
