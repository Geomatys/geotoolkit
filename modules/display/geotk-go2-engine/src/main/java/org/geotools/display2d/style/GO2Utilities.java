 ...
 */
package org.geotools.display2d.style;
...
import org.geotools.display2d.primitive.GeometryJ2D;
...
import org.geotools.display2d.style.raster.ShadedReliefCRIF;
import org.geotools.display2d.style.raster.ShadedReliefDescriptor;
...
public class GO2Utilities {
    ...
    static{
        ...
        try{
            ...
            RIFRegistry.register(or, fd.getName(), "org.geotools", rifJava);
        }catch(Exception ex){}
