 ...
 *         &lt;element ref="{http://www.opengis.net/sampling/1.0}SamplingFeature"/>
 *       &lt;/sequence>
...
@XmlType(name = "SamplingFeaturePropertyType", propOrder = {
    "samplingFeature"
})
public class SamplingFeaturePropertyType {
     ...
     *     
     */
    public void setSamplingFeature(JAXBElement<? extends SamplingFeatureEntry> value) {
