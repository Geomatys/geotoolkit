 ...
 *         &lt;element ref="{http://www.opengis.net/sampling/1.0}SpatiallyExtensiveSamplingFeature"/>
 *       &lt;/sequence>
...
@XmlType(name = "SpatiallyExtensiveSamplingFeaturePropertyType", propOrder = {
    "spatiallyExtensiveSamplingFeature"
})
public class SpatiallyExtensiveSamplingFeaturePropertyType {

    @XmlElementRef(name = "SpatiallyExtensiveSamplingFeature", namespace = "http://www.opengis.net/sampling/1.0", type = JAXBElement.class)
    private JAXBElement<? extends SpatiallyExtensiveSamplingFeatureType> spatiallyExtensiveSamplingFeature;
