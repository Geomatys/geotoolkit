...
public class MultiCurvePropertyType {
     ...
     *     
     */
    public void setMultiCurve(final MultiCurveType value) {
    ...
    public boolean equals(final Object object) {
        ...
        if (object instanceof MultiCurvePropertyType) {
            ...
            return Utilities.equals(this.actuate,            that.actuate)          &&
                   ...
                   Utilities.equals(this.multiCurve,         that.multiCurve);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hash = 5;
        hash = 47 * hash + (this.multiCurve != null ? this.multiCurve.hashCode() : 0);
