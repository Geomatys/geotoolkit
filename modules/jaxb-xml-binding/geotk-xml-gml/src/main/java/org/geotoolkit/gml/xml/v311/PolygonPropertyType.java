...
public class PolygonPropertyType {
    ...
    public boolean equals(final Object object) {
        ...
        if (object instanceof PolygonPropertyType) {
            ...
            return Utilities.equals(this.actuate,            that.actuate)          &&
                   ...
                   Utilities.equals(this.polygon,            that.polygon);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hash = 5;
        hash = 47 * hash + (this.polygon != null ? this.polygon.hashCode() : 0);
    ...
    public String toString() {
        StringBuilder s = new StringBuilder("[PolygonPropertyType]");
        if (polygon != null)
            s.append("polygon").append(polygon).append('\n');
