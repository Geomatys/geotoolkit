 ...
 *       &lt;group ref="{http://www.w3.org/1998/Math/MathML}MsrowExpression" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;attGroup ref="{http://www.w3.org/1998/Math/MathML}mscarry.attributes"/>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class Mscarry {
    ...
    protected java.util.List<Object> msrowExpression;
    ...
    public java.util.List<Object> getMsrowExpression() {
        if (msrowExpression == null) {
            msrowExpression = new ArrayList<Object>();
        }
        return this.msrowExpression;
    }
