 ...
 *         &lt;group ref="{http://www.w3.org/1998/Math/MathML}DomainQ"/>
...
@XmlType(name = "", propOrder = {
    "bvar",
    "domainofapplicationOrConditionOrLowlimit",
    "apply",
    "bind",
    "ci",
    "cn",
...
public class LambdaClass {
    ...
    protected java.util.List<Object> domainofapplicationOrConditionOrLowlimit;
    ...
    public java.util.List<Object> getDomainofapplicationOrConditionOrLowlimit() {
        if (domainofapplicationOrConditionOrLowlimit == null) {
            domainofapplicationOrConditionOrLowlimit = new ArrayList<Object>();
        }
        return this.domainofapplicationOrConditionOrLowlimit;
    }
