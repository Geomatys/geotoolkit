...
@XmlType(name = "GetAggregatedConceptIds", propOrder = {
    "uri",
    "language",
    "outputFormat",
    "theme",
...
public class GetAggregatedConceptIds {
    ...
    public GetAggregatedConceptIds() {

    }

    public GetAggregatedConceptIds(final String uri, final String language) {
    ...
    public GetAggregatedConceptIds(final URI uri, final String language) {
        this.language = language;
        if (uri != null) {
