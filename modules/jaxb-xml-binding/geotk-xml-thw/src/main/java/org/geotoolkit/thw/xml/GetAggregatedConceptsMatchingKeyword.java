...
@XmlRootElement(name = "GetAggregatedConceptsMatchingKeyword", namespace = "http://ws.geotk.org/")
public class GetAggregatedConceptsMatchingKeyword {
    ...
    public GetAggregatedConceptsMatchingKeyword() {
