...
@XmlType(name = "getNumeredConceptsMatchingKeywordResponse", propOrder = {
    "response",
    "labels"
})
@XmlRootElement(name = "GetNumeredConceptsMatchingKeywordResponse", namespace = "http://ws.geotk.org/")
public class GetNumeredConceptsMatchingKeywordResponse {
    ...
    public GetNumeredConceptsMatchingKeywordResponse() {

    }

    public GetNumeredConceptsMatchingKeywordResponse(final List<Concept> response, final List<String> labels) {
