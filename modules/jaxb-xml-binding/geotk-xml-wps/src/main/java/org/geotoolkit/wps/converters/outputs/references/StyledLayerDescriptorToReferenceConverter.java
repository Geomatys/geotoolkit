...
public class StyledLayerDescriptorToReferenceConverter extends AbstractReferenceOutputConverter<StyledLayerDescriptor> {
     ...
     */
    @Override
    public ReferenceType convert(final StyledLayerDescriptor source, final Map<String,Object> params) throws UnconvertibleObjectException {
        ...
        if (WPSIO.IOType.INPUT.equals(ioType)) {
