...
public class ServiceBindingType extends RegistryObjectType {
    ...
    public String toString() {
        ...
        if (specificationLink != null) {
            ...
            for (SpecificationLinkType sbi : specificationLink) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof ServiceBindingType && super.equals(obj)) {
            ...
            return Objects.equals(this.accessURI,         that.accessURI) &&
                   Objects.equals(this.service,           that.service) &&
                   Objects.equals(this.specificationLink, that.specificationLink) &&
                   Objects.equals(this.targetBinding,     that.targetBinding);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        hash = 53 * hash + (this.specificationLink != null ? this.specificationLink.hashCode() : 0);
        hash = 53 * hash + (this.service != null ? this.service.hashCode() : 0);
        hash = 53 * hash + (this.accessURI != null ? this.accessURI.hashCode() : 0);
        hash = 53 * hash + (this.targetBinding != null ? this.targetBinding.hashCode() : 0);
        return hash;
    }
}
