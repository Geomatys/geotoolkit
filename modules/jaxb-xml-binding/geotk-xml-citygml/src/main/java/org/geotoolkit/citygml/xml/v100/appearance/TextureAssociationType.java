...
public class TextureAssociationType {
    ...
    @XmlElementRef(name = "_TextureParameterization", namespace = "http://www.opengis.net/citygml/appearance/1.0", type = JAXBElement.class)
    private JAXBElement<? extends AbstractTextureParameterizationType> textureParameterization;
    ...
    public String toString() {
        ...
        if (textureParameterization != null) {
            sb.append("textureParameterization:").append(textureParameterization.getValue()).append('\n');
        }
        ...
        if (uri != null) {
            sb.append("uri: ").append(type).append('\n');
        }
        return sb.toString();
    }
}
