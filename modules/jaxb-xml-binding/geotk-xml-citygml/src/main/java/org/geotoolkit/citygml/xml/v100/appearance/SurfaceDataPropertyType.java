 ...
 *         &lt;element ref="{http://www.opengis.net/citygml/appearance/1.0}_SurfaceData" minOccurs="0"/>
 *       &lt;/sequence>
...
public class SurfaceDataPropertyType {
    ...
    @XmlElementRef(name = "_SurfaceData", namespace = "http://www.opengis.net/citygml/appearance/1.0", type = JAXBElement.class)
    private JAXBElement<? extends AbstractSurfaceDataType> surfaceData;
    ...
    public String toString() {
        ...
        if (surfaceData != null) {
            sb.append("surfaceData:").append(surfaceData.getValue()).append('\n');
        }
