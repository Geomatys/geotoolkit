 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.opengis.net/gmlcov/1.0}AbstractReferenceableGrid"/>
 *       &lt;/sequence>
...
public class ReferenceableGridPropertyType {

    @XmlElement(name = "AbstractReferenceableGrid", required = true)
    private AbstractReferenceableGridType abstractReferenceableGrid;
    @XmlAttribute
