...
import org.geotools.internal.jaxb.v100.sld.Rule;
import org.geotools.internal.jaxb.v100.sld.UserStyle;
...
import org.geotools.style.xml.SE100toGTTransformer;
...
public class SEforSLD100Test extends TestCase{
    ...
    static{
        ...
        try { 
            FILE_SE_SYMBOL_POINT = new File( SEforSLD100Test.class.getResource("/org/geotools/sample/SE_symbol_point_v100.xml").toURI() );
            FILE_SE_SYMBOL_LINE = new File( SEforSLD100Test.class.getResource("/org/geotools/sample/SE_symbol_line_v100.xml").toURI() );
            FILE_SE_SYMBOL_POLYGON = new File( SEforSLD100Test.class.getResource("/org/geotools/sample/SE_symbol_polygon_v100.xml").toURI() );
            FILE_SE_SYMBOL_TEXT = new File( SEforSLD100Test.class.getResource("/org/geotools/sample/SE_symbol_text_v100.xml").toURI() );
            FILE_SE_SYMBOL_RASTER = new File( SEforSLD100Test.class.getResource("/org/geotools/sample/SE_symbol_raster_v100.xml").toURI() );
            FILE_SE_STYLE = new File( SEforSLD100Test.class.getResource("/org/geotools/sample/SLD_userstyle_v100.xml").toURI() );
            FILE_SE_FTS = new File( SEforSLD100Test.class.getResource("/org/geotools/sample/SE_fts_v100.xml").toURI() );
            FILE_SE_RULE = new File( SEforSLD100Test.class.getResource("/org/geotools/sample/SE_rule_v100.xml").toURI() );
    ...
    public void testPointSymbolizer() throws JAXBException{
        ...
        JAXBElement<org.geotools.internal.jaxb.v100.sld.PointSymbolizer> jax = (JAXBElement<org.geotools.internal.jaxb.v100.sld.PointSymbolizer>) obj;
        ...
        //Write test
        JAXBElement<org.geotools.internal.jaxb.v100.sld.PointSymbolizer> pvt = TRANSFORMER_OGC.visit(pointSymbol,null);
        assertNotNull(pvt);
        
        assertEquals(pvt.getValue().getGeometry().getPropertyName().getContent() , "");
        org.geotools.internal.jaxb.v100.sld.Graphic gra = pvt.getValue().getGraphic();
    ...
    public void testLineSymbolizer() throws JAXBException{
        ...
        JAXBElement<org.geotools.internal.jaxb.v100.sld.LineSymbolizer> jax = (JAXBElement<org.geotools.internal.jaxb.v100.sld.LineSymbolizer>) obj;
        ...
        //Write test
        JAXBElement<org.geotools.internal.jaxb.v100.sld.LineSymbolizer> pvt = TRANSFORMER_OGC.visit(lineSymbol,null);
        assertNotNull(pvt);
    ...
    public void testPolygonSymbolizer() throws JAXBException{
        ...
        JAXBElement<org.geotools.internal.jaxb.v100.sld.PolygonSymbolizer> jax = (JAXBElement<org.geotools.internal.jaxb.v100.sld.PolygonSymbolizer>) obj;
        ...
        //Write test
        JAXBElement<org.geotools.internal.jaxb.v100.sld.PolygonSymbolizer> pvt = TRANSFORMER_OGC.visit(polySymbol,null);
        assertNotNull(pvt);
    ...
    public void testTextSymbolizer() throws JAXBException{
        ...
        JAXBElement<org.geotools.internal.jaxb.v100.sld.TextSymbolizer> jax = (JAXBElement<org.geotools.internal.jaxb.v100.sld.TextSymbolizer>) obj;
        ...
        //Write test
        JAXBElement<org.geotools.internal.jaxb.v100.sld.TextSymbolizer> pvt = TRANSFORMER_OGC.visit(textSymbol,null);
        assertNotNull(pvt);
    ...
    public void testRasterSymbolizer() throws JAXBException{
        ...
        JAXBElement<org.geotools.internal.jaxb.v100.sld.RasterSymbolizer> jax = (JAXBElement<org.geotools.internal.jaxb.v100.sld.RasterSymbolizer>) obj;
...
//        assertNotNull( rasterSymbol.getColorMap().getFunction() );
        ...
        //Write test
        JAXBElement<org.geotools.internal.jaxb.v100.sld.RasterSymbolizer> pvt = TRANSFORMER_OGC.visit(rasterSymbol,null);
        assertNotNull(pvt);
        
        org.geotools.internal.jaxb.v100.sld.RasterSymbolizer rs = pvt.getValue();
