...
package org.geotools.style.ogc;
...
import org.geotools.internal.jaxb.v110.ogc.BinaryComparisonOpType;
import org.geotools.internal.jaxb.v110.ogc.BinaryLogicOpType;
import org.geotools.internal.jaxb.v110.ogc.BinaryOperatorType;
import org.geotools.internal.jaxb.v110.ogc.ComparisonOpsType;
import org.geotools.internal.jaxb.v110.ogc.FilterType;
import org.geotools.internal.jaxb.v110.ogc.FunctionType;
import org.geotools.internal.jaxb.v110.ogc.LiteralType;
import org.geotools.internal.jaxb.v110.ogc.LogicOpsType;
import org.geotools.internal.jaxb.v110.ogc.PropertyIsBetweenType;
import org.geotools.internal.jaxb.v110.ogc.PropertyIsLikeType;
import org.geotools.internal.jaxb.v110.ogc.PropertyIsNullType;
import org.geotools.internal.jaxb.v110.ogc.PropertyNameType;
import org.geotools.internal.jaxb.v110.ogc.UnaryLogicOpType;
import org.geotools.internal.jaxb.v110.se.ParameterValueType;
import org.geotools.sld.DefaultSLDFactory;
import org.geotools.sld.MutableSLDFactory;
import org.geotools.style.MutableStyleFactory;
import org.geotools.style.xml.GTtoSE110Transformer;
import org.geotools.style.xml.JAXBStatics;
import org.geotools.style.xml.NamespacePrefixMapperImpl;
import org.geotools.style.xml.OGC110toGTTransformer;
...
public class OGCforSLD110Test extends TestCase{
    ...
    static {
        try {
            JAXBContext jaxbContext = JAXBContext.newInstance(org.geotools.internal.jaxb.v110.sld.StyledLayerDescriptor.class);
        ...
        try { 
            FILE_EXP_ADD = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Expression_Add.xml").toURI() );
            FILE_EXP_SUB = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Expression_Sub.xml").toURI() );
            FILE_EXP_MUL = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Expression_Mul.xml").toURI() );
            FILE_EXP_DIV = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Expression_Div.xml").toURI() );
            FILE_EXP_PROPERTYNAME = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Expression_PropertyName.xml").toURI() );
            FILE_EXP_LITERAL = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Expression_Literal.xml").toURI() );
            FILE_EXP_FUNCTION = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Expression_Function.xml").toURI() );
            
            FILE_FIL_COMP_ISBETWEEN = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Comparison_PropertyIsBetween.xml").toURI() );
            FILE_FIL_COMP_ISEQUAL = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Comparison_PropertyIsEqualTo.xml").toURI() );
            FILE_FIL_COMP_ISGREATER = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Comparison_PropertyIsGreaterThan.xml").toURI() );
            FILE_FIL_COMP_ISGREATEROREQUAL = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Comparison_PropertyIsGreaterThanOrEqualTo.xml").toURI() );
            FILE_FIL_COMP_ISLESS = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Comparison_PropertyIsLessThan.xml").toURI() );
            FILE_FIL_COMP_ISLESSOREQUAL = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Comparison_PropertyIsLessThanOrEqualTo.xml").toURI() );
            FILE_FIL_COMP_ISLIKE = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Comparison_PropertyIsLike_v110.xml").toURI() );
            FILE_FIL_COMP_ISNOTEQUAL = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Comparison_PropertyIsNotEqualTo.xml").toURI() );
            FILE_FIL_COMP_ISNULL = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Comparison_PropertyIsNull.xml").toURI() );
            FILE_FIL_LOG_AND = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Logical_And.xml").toURI() );
            FILE_FIL_LOG_OR = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Logical_Or.xml").toURI() );
            FILE_FIL_LOG_NOT = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Logical_Not.xml").toURI() );
            FILE_FIL_SPA_BBOX = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Spatial_BBOX.xml").toURI() );
            FILE_FIL_SPA_BEYOND = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Spatial_Beyond.xml").toURI() );
            FILE_FIL_SPA_CONTAINS = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Spatial_Contains.xml").toURI() );
            FILE_FIL_SPA_CROSSES = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Spatial_Crosses.xml").toURI() );
            FILE_FIL_SPA_DISJOINT = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Spatial_DWithin.xml").toURI() );
            FILE_FIL_SPA_DWITHIN = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Spatial_Disjoint.xml").toURI() );
            FILE_FIL_SPA_EQUALS = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Spatial_Equals.xml").toURI() );
            FILE_FIL_SPA_INTERSECTS = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Spatial_Intersects.xml").toURI() );
            FILE_FIL_SPA_OVERLAPS = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Spatial_Overlaps.xml").toURI() );
            FILE_FIL_SPA_TOUCHES = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Spatial_Touches.xml").toURI() );
            FILE_FIL_SPA_WITHIN = new File( OGCforSLD110Test.class.getResource("/org/geotools/sample/Filter_Spatial_Within.xml").toURI() );
