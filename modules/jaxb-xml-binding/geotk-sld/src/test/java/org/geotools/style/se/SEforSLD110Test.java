...
import org.geotools.internal.jaxb.v110.se.ObjectFactory;
...
import org.geotools.style.xml.SE110toGTTransformer;
...
public class SEforSLD110Test extends TestCase{
    ...
    static{
        ...
        try { 
            FILE_SE_SYMBOL_POINT = new File( SEforSLD110Test.class.getResource("/org/geotools/sample/SE_symbol_point_v110.xml").toURI() );
            FILE_SE_SYMBOL_LINE = new File( SEforSLD110Test.class.getResource("/org/geotools/sample/SE_symbol_line_v110.xml").toURI() );
            FILE_SE_SYMBOL_POLYGON = new File( SEforSLD110Test.class.getResource("/org/geotools/sample/SE_symbol_polygon_v110.xml").toURI() );
            FILE_SE_SYMBOL_TEXT = new File( SEforSLD110Test.class.getResource("/org/geotools/sample/SE_symbol_text_v110.xml").toURI() );
            FILE_SE_SYMBOL_RASTER = new File( SEforSLD110Test.class.getResource("/org/geotools/sample/SE_symbol_raster_v110.xml").toURI() );
            FILE_SE_STYLE = new File( SEforSLD110Test.class.getResource("/org/geotools/sample/SLD_userstyle_v110.xml").toURI() );
            FILE_SE_FTS = new File( SEforSLD110Test.class.getResource("/org/geotools/sample/SE_fts_v110.xml").toURI() );
            FILE_SE_RULE = new File( SEforSLD110Test.class.getResource("/org/geotools/sample/SE_rule_v110.xml").toURI() );
    ...
    public void testPointSymbolizer() throws JAXBException{
        ...
        JAXBElement<org.geotools.internal.jaxb.v110.se.PointSymbolizerType> jax = (JAXBElement<org.geotools.internal.jaxb.v110.se.PointSymbolizerType>) obj;
        ...
        //Write test
        JAXBElement<org.geotools.internal.jaxb.v110.se.PointSymbolizerType> pvt = TRANSFORMER_OGC.visit(pointSymbol,null);
        assertNotNull(pvt);
        
        assertEquals(pvt.getValue().getGeometry().getPropertyName().getContent() , "");
        org.geotools.internal.jaxb.v110.se.GraphicType gra = pvt.getValue().getGraphic();
    ...
    public void testLineSymbolizer() throws JAXBException{
        ...
        JAXBElement<org.geotools.internal.jaxb.v110.se.LineSymbolizerType> jax = (JAXBElement<org.geotools.internal.jaxb.v110.se.LineSymbolizerType>) obj;
        ...
        //Write test
        JAXBElement<org.geotools.internal.jaxb.v110.se.LineSymbolizerType> pvt = TRANSFORMER_OGC.visit(lineSymbol,null);
        assertNotNull(pvt);
    ...
    public void testPolygonSymbolizer() throws JAXBException{
        ...
        JAXBElement<org.geotools.internal.jaxb.v110.se.PolygonSymbolizerType> jax = (JAXBElement<org.geotools.internal.jaxb.v110.se.PolygonSymbolizerType>) obj;
        ...
        //Write test
        JAXBElement<org.geotools.internal.jaxb.v110.se.PolygonSymbolizerType> pvt = TRANSFORMER_OGC.visit(polySymbol,null);
        assertNotNull(pvt);
    ...
    public void testTextSymbolizer() throws JAXBException{
        ...
        JAXBElement<org.geotools.internal.jaxb.v110.se.TextSymbolizerType> jax = (JAXBElement<org.geotools.internal.jaxb.v110.se.TextSymbolizerType>) obj;
        ...
        //Write test
        JAXBElement<org.geotools.internal.jaxb.v110.se.TextSymbolizerType> pvt = TRANSFORMER_OGC.visit(textSymbol,null);
        assertNotNull(pvt);
    ...
    public void testRasterSymbolizer() throws JAXBException{
        ...
        JAXBElement<org.geotools.internal.jaxb.v110.se.RasterSymbolizerType> jax = (JAXBElement<org.geotools.internal.jaxb.v110.se.RasterSymbolizerType>) obj;
...
//        assertNotNull( rasterSymbol.getColorMap().getFunction() );
        ...
        //Write test
        JAXBElement<org.geotools.internal.jaxb.v110.se.RasterSymbolizerType> pvt = TRANSFORMER_OGC.visit(rasterSymbol,null);
        assertNotNull(pvt);
        
        org.geotools.internal.jaxb.v110.se.RasterSymbolizerType rs = pvt.getValue();
