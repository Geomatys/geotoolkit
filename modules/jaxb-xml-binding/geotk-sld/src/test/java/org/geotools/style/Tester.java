...
import org.geotools.style.xml.JAXBSLDUtilities;
...
public class Tester {
    ...
    public static void main(String[] args) {
        ...
        try { testSLDUnMarshall_V100(new File(Tester.class.getResource("/org/geotools/sample/SLD100.xml").toURI()));
        } catch (URISyntaxException ex) { ex.printStackTrace(); }
        
        try { testSLDUnMarshall_V110(new File(Tester.class.getResource("/org/geotools/sample/SLD110.xml").toURI()));
        } catch (URISyntaxException ex) { ex.printStackTrace(); }
    ...
    private static void testSLDMarshall_V100(File file) {
        ...
        org.geotools.internal.jaxb.v100.sld.StyledLayerDescriptor sld = SLD_UTILITIES.transform_V100(geoSLD);
        SLD_UTILITIES.marshall_V100(sld, file);
    }

    private static void testSLDUnMarshall_V100(File file) {        
        org.geotools.internal.jaxb.v100.sld.StyledLayerDescriptor sld = SLD_UTILITIES.unmarshall_V100(file);
    ...
    private static void testSLDMarshall_V110(File file) {
        StyledLayerDescriptor geoSLD = createSLD();
        org.geotools.internal.jaxb.v110.sld.StyledLayerDescriptor sld = SLD_UTILITIES.transform_V110(geoSLD);
        SLD_UTILITIES.marshall_V110(sld, file);
    }
    
    private static void testSLDUnMarshall_V110(File file) {        
        org.geotools.internal.jaxb.v110.sld.StyledLayerDescriptor sld = SLD_UTILITIES.unmarshall_V110(file);
    ...
    private static void showSLD(org.geotools.internal.jaxb.v110.sld.StyledLayerDescriptor sld){
        
        System.out.println("NAME =" + sld.getName());
        
        org.geotools.internal.jaxb.v110.se.DescriptionType des = sld.getDescription();
        System.out.println("DESC : title="+des.getTitle());
        System.out.println("DESC : abstract="+des.getAbstract());
        
        for(org.geotools.internal.jaxb.v110.sld.UseSLDLibrary lib : sld.getUseSLDLibrary()){
            System.out.println("SLD_LIB : resource=" + lib.getOnlineResource());
        }
        
        for(Object obj : sld.getNamedLayerOrUserLayer()){
            if(obj instanceof org.geotools.internal.jaxb.v110.sld.NamedLayer){
                org.geotools.internal.jaxb.v110.sld.NamedLayer named = (org.geotools.internal.jaxb.v110.sld.NamedLayer) obj;
                System.out.println("LAYER : NAMED : name=" + named.getName());
                org.geotools.internal.jaxb.v110.se.DescriptionType desc = named.getDescription();
                if(desc != null){
                    System.out.println("LAYER : NAMED : DESC : title=" + desc.getTitle());
                    System.out.println("LAYER : NAMED : DESC : abstract=" + desc.getAbstract());
                }
                
                org.geotools.internal.jaxb.v110.sld.LayerFeatureConstraints cons = named.getLayerFeatureConstraints();
                for(org.geotools.internal.jaxb.v110.sld.FeatureTypeConstraint con : cons.getFeatureTypeConstraint()){
                    System.out.println("LAYER : NAMED : CONSTR : ftname=" + con.getFeatureTypeName());
                }
                
                for(Object style : named.getNamedStyleOrUserStyle()){
                    if(style instanceof org.geotools.internal.jaxb.v110.sld.NamedStyle){
                        org.geotools.internal.jaxb.v110.sld.NamedStyle ns = (org.geotools.internal.jaxb.v110.sld.NamedStyle) style;
                        System.out.println("LAYER : NAMED : STYLE : NAMED : name=" + ns.getName());
                        org.geotools.internal.jaxb.v110.se.DescriptionType nsdesc = ns.getDescription();
                        if(desc != null){
                    ...
                    }else if(style instanceof org.geotools.internal.jaxb.v110.sld.UserStyle){
                        
                    }
                }
                
            }else if(obj instanceof org.geotools.internal.jaxb.v110.sld.UserLayer){
                org.geotools.internal.jaxb.v110.sld.UserLayer user = (org.geotools.internal.jaxb.v110.sld.UserLayer) obj;
                System.out.println("LAYER : USER : name=" + user.getName());
                org.geotools.internal.jaxb.v110.se.DescriptionType desc = user.getDescription();
                if(desc != null){
                    System.out.println("LAYER : USER : DESC : title=" + desc.getTitle());
                    System.out.println("LAYER : USER : DESC : abstract=" + desc.getAbstract());
                }
                                
                org.geotools.internal.jaxb.v110.sld.RemoteOWS ows = user.getRemoteOWS();
                if(ows != null){
                    System.out.println("LAYER : USER : OWS : service="+ows.getService());
                    System.out.println("LAYER : USER : OWS : resource="+ows.getOnlineResource());
                }
                
                org.geotools.internal.jaxb.v110.sld.LayerFeatureConstraints ftcons = user.getLayerFeatureConstraints();
                for(org.geotools.internal.jaxb.v110.sld.FeatureTypeConstraint con : ftcons.getFeatureTypeConstraint()){
                    System.out.println("LAYER : USER : FT_CONSTR : ftname=" + con.getFeatureTypeName());
                }
                
                org.geotools.internal.jaxb.v110.sld.LayerCoverageConstraints cvcons = user.getLayerCoverageConstraints();
                for(org.geotools.internal.jaxb.v110.sld.CoverageConstraint con : cvcons.getCoverageConstraint()){
                    System.out.println("LAYER : USER : CV_CONSTR : cname=" + con.getCoverageName());
                    org.geotools.internal.jaxb.v110.sld.CoverageExtent ext = con.getCoverageExtent();
                    if(ext != null){
                        if(ext.getTimePeriod() != null){
                            System.out.println("LAYER : USER : CV_CONSTR : EXTENT : timeperiod=" + ext.getTimePeriod());
                        }
                        
                        for(org.geotools.internal.jaxb.v110.sld.RangeAxis axi : ext.getRangeAxis()){
