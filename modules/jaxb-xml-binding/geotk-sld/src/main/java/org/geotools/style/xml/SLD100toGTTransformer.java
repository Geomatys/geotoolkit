...
import org.geotools.internal.jaxb.v100.sld.LayerFeatureConstraints;
import org.geotools.internal.jaxb.v100.sld.NamedLayer;
import org.geotools.internal.jaxb.v100.sld.StyledLayerDescriptor;
import org.geotools.internal.jaxb.v100.sld.UserLayer;
...
public class SLD100toGTTransformer extends SE100toGTTransformer{
    ...
    public Collection<? extends FeatureTypeConstraint> visitFeatureConstraints(LayerFeatureConstraints ftc){
        if(ftc == null || ftc.getFeatureTypeConstraint() == null || ftc.getFeatureTypeConstraint().isEmpty()){
            ...
            for(org.geotools.internal.jaxb.v100.sld.FeatureTypeConstraint aftc : ftc.getFeatureTypeConstraint()){
     ...
     */
    public List<Extent> visitExtents(List<org.geotools.internal.jaxb.v100.sld.Extent> exts){
        if(exts == null || exts.isEmpty()){
            return Collections.emptyList();
        }else{
            List<Extent> extents = new ArrayList<Extent>();
            
            for(org.geotools.internal.jaxb.v100.sld.Extent ex : exts){
     ...
     */
    public RemoteOWS visiteRemoteOWS(org.geotools.internal.jaxb.v100.sld.RemoteOWS ows){
        if(ows == null){
            return null;
        }else{
    ...
    public Collection<? extends MutableLayerStyle> visitStyles(List<Object> styles){
        if(styles == null || styles.isEmpty()){
            ...
            for(Object obj : styles){
                ...
                if(obj instanceof org.geotools.internal.jaxb.v100.sld.NamedStyle){
                    org.geotools.internal.jaxb.v100.sld.NamedStyle ns = (org.geotools.internal.jaxb.v100.sld.NamedStyle) obj;
                    MutableNamedStyle mns = sldFactory.createNamedStyle();
                    mns.setName(ns.getName());
                    mStyles.add(mns);
                }else if(obj instanceof org.geotools.internal.jaxb.v100.sld.UserStyle){
                    org.geotools.internal.jaxb.v100.sld.UserStyle us = (org.geotools.internal.jaxb.v100.sld.UserStyle) obj;
    ...
    public Collection<? extends MutableStyle> visitUserStyles(List<UserStyle> styles){
        if(styles == null || styles.isEmpty()){
            ...
            for(org.geotools.internal.jaxb.v100.sld.UserStyle us : styles){
                //we call SE transformer for this part
                mStyles.add(visitUserStyle(us));
            }
