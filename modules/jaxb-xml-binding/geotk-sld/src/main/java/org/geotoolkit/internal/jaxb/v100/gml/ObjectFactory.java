...
public class ObjectFactory {
    ...
    private final static QName _AbstractGeometry_QNAME = new QName("http://www.opengis.net/gml", "_Geometry");
     ...
     *
     */
    @XmlElementDecl(namespace = "http://www.opengis.net/gml", name = "AbstractGeometryCollection", substitutionHeadNamespace = "http://www.opengis.net/gml", substitutionHeadName = "_Geometry")
