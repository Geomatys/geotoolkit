...
public class NotificationProducerMetadataPropertyType {
    ...
    @XmlElementRef(name = "NotificationProducerMetadata", namespace = "http://www.opengis.net/swes/2.0", type = JAXBElement.class)
    private JAXBElement<? extends NotificationProducerMetadataType> notificationProducerMetadata;
    @XmlAttribute
