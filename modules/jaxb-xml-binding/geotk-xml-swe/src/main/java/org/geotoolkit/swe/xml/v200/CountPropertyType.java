...
public class CountPropertyType implements AbstractElementCount {
    ...
    public CountPropertyType(final CountPropertyType that) {
    ...
    public String toString() {
        final StringBuilder s = new StringBuilder("[CountPropertyType]\n");
        if(count != null) {
