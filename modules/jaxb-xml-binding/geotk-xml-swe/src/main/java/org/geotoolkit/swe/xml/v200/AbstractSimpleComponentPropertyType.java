...
public class AbstractSimpleComponentPropertyType {
    ...
    @XmlElementRef(name = "AbstractSimpleComponent", namespace = "http://www.opengis.net/swe/2.0", type = JAXBElement.class)
    private JAXBElement<? extends AbstractSimpleComponentType> abstractSimpleComponent;
