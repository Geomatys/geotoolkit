...
public class OGC100toGTTransformer {
     ...
     */
    public Filter visitFilter(org.geotools.internal.jaxb.v100.ogc.FilterType ft){
        if(ft == null)return null;        
        
        if(ft.getComparisonOps() != null){
            final JAXBElement<? extends org.geotools.internal.jaxb.v100.ogc.ComparisonOpsType> jax = ft.getComparisonOps();
            return visitComparisonOp(jax);     
        }else if(ft.getLogicOps() != null){
            final JAXBElement<? extends org.geotools.internal.jaxb.v100.ogc.LogicOpsType> jax = ft.getLogicOps();
            return visitLogicOp(jax);
        }else if(ft.getSpatialOps() != null){
            final JAXBElement<? extends org.geotools.internal.jaxb.v100.ogc.SpatialOpsType> jax = ft.getSpatialOps();
     ...
     */
    public Filter visitSpatialOp(final JAXBElement<? extends org.geotools.internal.jaxb.v100.ogc.SpatialOpsType> jax) {
        final org.geotools.internal.jaxb.v100.ogc.SpatialOpsType ops = jax.getValue();
        final String OpName = jax.getName().getLocalPart();

        if (ops instanceof org.geotools.internal.jaxb.v100.ogc.BinarySpatialOpType) {
            org.geotools.internal.jaxb.v100.ogc.BinarySpatialOpType binary = (org.geotools.internal.jaxb.v100.ogc.BinarySpatialOpType) ops;
            JAXBElement<? extends org.geotools.internal.jaxb.v100.gml.AbstractGeometryType> geom = binary.getGeometry();
            org.geotools.internal.jaxb.v100.ogc.PropertyNameType pnt = binary.getPropertyName();
        ...
        } else if (ops instanceof org.geotools.internal.jaxb.v100.ogc.DistanceBufferType) {
            org.geotools.internal.jaxb.v100.ogc.DistanceBufferType dstOp = (org.geotools.internal.jaxb.v100.ogc.DistanceBufferType) ops;
            org.geotools.internal.jaxb.v100.ogc.DistanceType dt = dstOp.getDistance();
            JAXBElement<? extends org.geotools.internal.jaxb.v100.gml.AbstractGeometryType> geom = dstOp.getGeometry();
            org.geotools.internal.jaxb.v100.ogc.PropertyNameType pnt = dstOp.getPropertyName();

            Expression geom1 = filterFactory.property(pnt.getContent());
            Expression geom2 = visit(geom);
            double distance = Double.valueOf(dt.getContent());
        ...
        } else if (ops instanceof org.geotools.internal.jaxb.v100.ogc.BBOXType) {
            org.geotools.internal.jaxb.v100.ogc.BBOXType binary = (org.geotools.internal.jaxb.v100.ogc.BBOXType) ops;
            org.geotools.internal.jaxb.v100.gml.BoxType box = binary.getBox();
            org.geotools.internal.jaxb.v100.ogc.PropertyNameType pnt = binary.getPropertyName();
            
            Expression geom = filterFactory.property(pnt.getContent());
            double minx = box.getCoord().get(0).getX().doubleValue();
            double maxx = box.getCoord().get(1).getX().doubleValue();
            double miny = box.getCoord().get(0).getY().doubleValue();
            double maxy = box.getCoord().get(1).getY().doubleValue();
     ...
     */
    public Filter visitLogicOp(final JAXBElement<? extends org.geotools.internal.jaxb.v100.ogc.LogicOpsType> jax) {
        final org.geotools.internal.jaxb.v100.ogc.LogicOpsType ops = jax.getValue();
        final String OpName = jax.getName().getLocalPart();

        if (ops instanceof org.geotools.internal.jaxb.v100.ogc.UnaryLogicOpType) {
            org.geotools.internal.jaxb.v100.ogc.UnaryLogicOpType unary = (org.geotools.internal.jaxb.v100.ogc.UnaryLogicOpType) ops;
        ...
        } else if (ops instanceof org.geotools.internal.jaxb.v100.ogc.BinaryLogicOpType) {
            org.geotools.internal.jaxb.v100.ogc.BinaryLogicOpType binary = (org.geotools.internal.jaxb.v100.ogc.BinaryLogicOpType) ops;
            ...
            if (JAXBStatics.FILTER_LOGIC_AND.equalsIgnoreCase(OpName)) {
                ...
                for(JAXBElement<?> ele : binary.getComparisonOpsOrSpatialOpsOrLogicOps()){
                    ...
                    if(obj instanceof org.geotools.internal.jaxb.v100.ogc.ComparisonOpsType){
                        filters.add(visitComparisonOp( (JAXBElement<? extends org.geotools.internal.jaxb.v100.ogc.ComparisonOpsType>) ele ));
                    }else if(obj instanceof org.geotools.internal.jaxb.v100.ogc.SpatialOpsType){
                        filters.add(visitSpatialOp( (JAXBElement<? extends org.geotools.internal.jaxb.v100.ogc.SpatialOpsType>) ele ));
                    }else if(obj instanceof org.geotools.internal.jaxb.v100.ogc.LogicOpsType){
                        filters.add(visitLogicOp( (JAXBElement<? extends org.geotools.internal.jaxb.v100.ogc.LogicOpsType>) ele ));
                    }
                }
     ...
     */
    public Filter visitComparisonOp(final JAXBElement<? extends org.geotools.internal.jaxb.v100.ogc.ComparisonOpsType> jax){
        final org.geotools.internal.jaxb.v100.ogc.ComparisonOpsType ops = jax.getValue();
        final String OpName = jax.getName().getLocalPart();

        if (ops instanceof org.geotools.internal.jaxb.v100.ogc.BinaryComparisonOpType) {
            org.geotools.internal.jaxb.v100.ogc.BinaryComparisonOpType binary = (org.geotools.internal.jaxb.v100.ogc.BinaryComparisonOpType) ops;
        ...
        } else if (ops instanceof org.geotools.internal.jaxb.v100.ogc.PropertyIsLikeType) {
            org.geotools.internal.jaxb.v100.ogc.PropertyIsLikeType property = (org.geotools.internal.jaxb.v100.ogc.PropertyIsLikeType) ops;
            ...
            String escape = property.getEscape();
        ...
        } else if (ops instanceof org.geotools.internal.jaxb.v100.ogc.PropertyIsBetweenType) {
            org.geotools.internal.jaxb.v100.ogc.PropertyIsBetweenType property = (org.geotools.internal.jaxb.v100.ogc.PropertyIsBetweenType) ops;
        ...
        } else if (ops instanceof org.geotools.internal.jaxb.v100.ogc.PropertyIsNullType) {
            org.geotools.internal.jaxb.v100.ogc.PropertyIsNullType property = (org.geotools.internal.jaxb.v100.ogc.PropertyIsNullType) ops;
     ...
     */
    public Filter visitIds(List<org.geotools.internal.jaxb.v100.ogc.FeatureIdType> lst){
        Set<Identifier> ids = new HashSet<Identifier>();
        
        for(org.geotools.internal.jaxb.v100.ogc.FeatureIdType id : lst){
    ...
    public Expression visit(JAXBElement<? extends org.geotools.internal.jaxb.v100.gml.AbstractGeometryType> ele){
...
//        JAXBElementBinaryOperatorType> ---k 
     ...
     */
    public Expression visitExpression(org.geotools.internal.jaxb.v100.sld.ParameterValueType param) {
