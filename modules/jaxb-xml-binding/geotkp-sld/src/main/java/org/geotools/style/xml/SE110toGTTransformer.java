...
import org.geotools.internal.jaxb.v110.se.SymbolizerType;
...
public class SE110toGTTransformer extends OGC110toGTTransformer {
    ...
    public OnLineResource visitOnlineResource(final org.geotools.internal.jaxb.v110.se.OnlineResourceType ort) {
        URI uri = null;
        try {
...
//        JAXBElementBinaryOperatorType>
     ...
     */
    public MutableStyle visitUserStyle(org.geotools.internal.jaxb.v110.sld.UserStyle us) {
        if(us == null){
            return null;
        }else{
     ...
     * Trasnform SLD v1.1 rule in GT Rule.
     */
    public MutableRule visitRule(org.geotools.internal.jaxb.v110.se.RuleType rt) {
        ...
        if(rt.getSymbolizer() == null || rt.getSymbolizer().isEmpty()){
            ...
            for(JAXBElement<? extends org.geotools.internal.jaxb.v110.se.SymbolizerType> jax : rt.getSymbolizer()) {
                org.geotools.internal.jaxb.v110.se.SymbolizerType st = jax.getValue();

                if (st == null) {
                    continue;
                }
                if (st instanceof org.geotools.internal.jaxb.v110.se.PointSymbolizerType) {
                    org.geotools.internal.jaxb.v110.se.PointSymbolizerType pst = (org.geotools.internal.jaxb.v110.se.PointSymbolizerType) st;
                    rule.symbolizers().add(visit(pst));
                } else if (st instanceof org.geotools.internal.jaxb.v110.se.LineSymbolizerType) {
                    org.geotools.internal.jaxb.v110.se.LineSymbolizerType pst = (org.geotools.internal.jaxb.v110.se.LineSymbolizerType) st;
                    rule.symbolizers().add(visit(pst));
                } else if (st instanceof org.geotools.internal.jaxb.v110.se.PolygonSymbolizerType) {
                    org.geotools.internal.jaxb.v110.se.PolygonSymbolizerType pst = (org.geotools.internal.jaxb.v110.se.PolygonSymbolizerType) st;
                    rule.symbolizers().add(visit(pst));
                } else if (st instanceof org.geotools.internal.jaxb.v110.se.TextSymbolizerType) {
                    org.geotools.internal.jaxb.v110.se.TextSymbolizerType pst = (org.geotools.internal.jaxb.v110.se.TextSymbolizerType) st;
                    rule.symbolizers().add(visit(pst));
                } else if (st instanceof org.geotools.internal.jaxb.v110.se.RasterSymbolizerType) {
                    org.geotools.internal.jaxb.v110.se.RasterSymbolizerType pst = (org.geotools.internal.jaxb.v110.se.RasterSymbolizerType) st;
                    rule.symbolizers().add(visit(pst));
                }
            }
...
//        ExternalMark = visit(markType.get)
     ...
     */
    private SelectedChannelType visit(org.geotools.internal.jaxb.v110.se.SelectedChannelType channel) {
