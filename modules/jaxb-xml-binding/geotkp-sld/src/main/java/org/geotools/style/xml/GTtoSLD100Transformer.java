...
public class GTtoSLD100Transformer extends GTtoSE100Transformer implements SLDVisitor {
    ...
    private final org.geotools.internal.jaxb.v100.sld.ObjectFactory sld_factory;

    public GTtoSLD100Transformer() {
        this.sld_factory = new org.geotools.internal.jaxb.v100.sld.ObjectFactory();
    }

    @Override
    public org.geotools.internal.jaxb.v100.sld.StyledLayerDescriptor visit(StyledLayerDescriptor sld, Object data) {
        org.geotools.internal.jaxb.v100.sld.StyledLayerDescriptor versionned = sld_factory.createStyledLayerDescriptor();
...
//        versionned.setVersion(sld.getVersion());
    ...
    @Override
    public org.geotools.internal.jaxb.v100.sld.NamedLayer visit(NamedLayer layer, Object data) {
        org.geotools.internal.jaxb.v100.sld.NamedLayer named = sld_factory.createNamedLayer();
    ...
    @Override
    public org.geotools.internal.jaxb.v100.sld.UserLayer visit(UserLayer layer, Object data) {
        org.geotools.internal.jaxb.v100.sld.UserLayer user = sld_factory.createUserLayer();
    ...
    @Override
    public org.geotools.internal.jaxb.v100.sld.NamedStyle visit(NamedStyle style, Object data) {
        org.geotools.internal.jaxb.v100.sld.NamedStyle named = sld_factory.createNamedStyle();
    ...
    @Override
    public org.geotools.internal.jaxb.v100.sld.LayerFeatureConstraints visit(LayerFeatureConstraints constraints, Object data) {
        org.geotools.internal.jaxb.v100.sld.LayerFeatureConstraints cons = sld_factory.createLayerFeatureConstraints();
    ...
    @Override
    public org.geotools.internal.jaxb.v100.sld.FeatureTypeConstraint visit(FeatureTypeConstraint constraint, Object data) {
        org.geotools.internal.jaxb.v100.sld.FeatureTypeConstraint ftc = sld_factory.createFeatureTypeConstraint();
    ...
    @Override
    public org.geotools.internal.jaxb.v100.sld.Extent visit(Extent extent, Object data) {
        org.geotools.internal.jaxb.v100.sld.Extent ext = sld_factory.createExtent();
    ...
    @Override
    public org.geotools.internal.jaxb.v100.sld.RemoteOWS visit(RemoteOWS ows, Object data) {
        org.geotools.internal.jaxb.v100.sld.RemoteOWS remote = sld_factory.createRemoteOWS();
