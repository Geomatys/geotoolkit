...
package org.geotools.style.sld;

import org.geotools.style.xml.GTtoSLD110Transformer;
import org.geotools.style.xml.SLD110toGTTransformer;
import java.io.File;
...
public class SLD110Test extends TestCase{
    ...
    static {
        ...
        try { 
            FILE_SLD = new File( SLD100Test.class.getResource("/org/geotools/sample/SLD_v110.xml").toURI()  );
    ...
    public void testSLD() throws JAXBException{
        ...
        //Named Layer-----------------------------------------------------------
        org.geotools.internal.jaxb.v110.sld.NamedLayer nlt = (org.geotools.internal.jaxb.v110.sld.NamedLayer) pvt.getNamedLayerOrUserLayer().get(0);
        ...
        List<org.geotools.internal.jaxb.v110.sld.FeatureTypeConstraint> constr = nlt.getLayerFeatureConstraints().getFeatureTypeConstraint();
        ...
        org.geotools.internal.jaxb.v110.sld.Extent extx = constr.get(0).getExtent().get(0);
        ...
        org.geotools.internal.jaxb.v110.sld.NamedStyle nst = (org.geotools.internal.jaxb.v110.sld.NamedStyle) nlt.getNamedStyleOrUserStyle().get(0);
        ...
        //User Layer------------------------------------------------------------
        org.geotools.internal.jaxb.v110.sld.UserLayer ulx = (org.geotools.internal.jaxb.v110.sld.UserLayer)pvt.getNamedLayerOrUserLayer().get(1);
        ...
        org.geotools.internal.jaxb.v110.sld.RemoteOWS sourcex = (org.geotools.internal.jaxb.v110.sld.RemoteOWS) ulx.getRemoteOWS();
