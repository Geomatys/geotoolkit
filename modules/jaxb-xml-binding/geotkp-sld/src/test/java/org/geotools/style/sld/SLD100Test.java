...
import org.geotools.style.xml.SLD100toGTTransformer;
import java.io.File;
...
import org.geotools.style.xml.GTtoSLD100Transformer;
...
public class SLD100Test extends TestCase{
    ...
    static {
        ...
        try { 
            FILE_SLD = new File( SLD100Test.class.getResource("/org/geotools/sample/SLD_v100.xml").toURI()  );
    ...
    public void testSLD() throws JAXBException{
        ...
        //Named Layer-----------------------------------------------------------
        org.geotools.internal.jaxb.v100.sld.NamedLayer nlt = (org.geotools.internal.jaxb.v100.sld.NamedLayer) pvt.getNamedLayerOrUserLayer().get(0);
        assertEquals(nlt.getName(), "Named layer : name");
        //no title, no description in SLD1.0        
        List<org.geotools.internal.jaxb.v100.sld.FeatureTypeConstraint> constr = nlt.getLayerFeatureConstraints().getFeatureTypeConstraint();
        ...
        org.geotools.internal.jaxb.v100.sld.Extent extx = constr.get(0).getExtent().get(0);
        ...
        org.geotools.internal.jaxb.v100.sld.NamedStyle nst = (org.geotools.internal.jaxb.v100.sld.NamedStyle) nlt.getNamedStyleOrUserStyle().get(0);
        assertEquals(nst.getName(), "Named style : name");
        
        //User Layer------------------------------------------------------------
        org.geotools.internal.jaxb.v100.sld.UserLayer ulx = (org.geotools.internal.jaxb.v100.sld.UserLayer)pvt.getNamedLayerOrUserLayer().get(1);
        assertEquals(ulx.getName(), "User layer : name");
        //no title, no description in SLD1.0   
        
        org.geotools.internal.jaxb.v100.sld.RemoteOWS sourcex = (org.geotools.internal.jaxb.v100.sld.RemoteOWS) ulx.getRemoteOWS();
