...
public class XMLUtilitiesTest extends TestCase{
    ...
    public XMLUtilitiesTest(){
        ...
        try {
            FILE_SLD_V100 = new File( XMLUtilitiesTest.class.getResource("/org/geotools/sample/SLD_v100.xml").toURI()  );
            FILE_SLD_V110 = new File( XMLUtilitiesTest.class.getResource("/org/geotools/sample/SLD_v110.xml").toURI()  );
            FILE_STYLE_V100 = new File( XMLUtilitiesTest.class.getResource("/org/geotools/sample/SLD_userstyle_v100.xml").toURI()  );
            FILE_STYLE_V110 = new File( XMLUtilitiesTest.class.getResource("/org/geotools/sample/SLD_userstyle_v110.xml").toURI()  );
            FILE_FTS_V100 = new File( XMLUtilitiesTest.class.getResource("/org/geotools/sample/SE_fts_v100.xml").toURI()  );
            FILE_FTS_V110 = new File( XMLUtilitiesTest.class.getResource("/org/geotools/sample/SE_fts_v110.xml").toURI()  );
            FILE_RULE_V100 = new File( XMLUtilitiesTest.class.getResource("/org/geotools/sample/SE_rule_v100.xml").toURI()  );
            FILE_RULE_V110 = new File( XMLUtilitiesTest.class.getResource("/org/geotools/sample/SE_rule_v110.xml").toURI()  );
            FILE_FILTER_V100 = new File( XMLUtilitiesTest.class.getResource("/org/geotools/sample/Filter_Comparison_PropertyIsBetween.xml").toURI()  );
            FILE_FILTER_V110 = new File( XMLUtilitiesTest.class.getResource("/org/geotools/sample/Filter_Comparison_PropertyIsBetween.xml").toURI()  );
    ...
    public void testSLDReading() throws JAXBException{
        ...
        sld = util.readSLD(FILE_SLD_V100, org.geotools.style.xml.Specification.StyledLayerDescriptor.V_1_0_0);
        assertNotNull(sld);
        sld = util.readSLD(FILE_SLD_V110, org.geotools.style.xml.Specification.StyledLayerDescriptor.V_1_1_0);
        assertNotNull(sld);
    }
