 ...
 * @module pending
 */
public class SoftwareAdapter extends MetadataAdapter<SoftwareAdapter, GNC_Software>
{
    /**
    ...
    /**
     * Wraps an ContentInformation value with a {@code GNC_Software} element at marshalling time.
     *
     * @param metadata The metadata value to marshall.
     */
    private SoftwareAdapter(final GNC_Software metadata) {
        super(metadata);
    }
     ...
     */
    @Override
    protected SoftwareAdapter wrap(final GNC_Software value) {
        return new SoftwareAdapter(value);
    }
