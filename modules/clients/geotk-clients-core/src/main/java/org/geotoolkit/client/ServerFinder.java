...
/**
 * Creates {@link Server} instances from a set of parameters.
 *
 * {@section Registration}
 * {@link Server} factories must implement the {@link ServerFactory} interface and declare their
 ...
 */
@ThreadSafe
public final class ServerFinder extends Static {
    /**
     ...
     */
    private static final ServiceLoader<ServerFactory> loader = ServiceLoader.load(ServerFactory.class);
     ...
     */
    private static synchronized <T extends ServerFactory> Set<T> getFactories(final Class<T> type, final boolean all) {
        final Iterator<ServerFactory> factories = loader.iterator();
            ...
            public boolean hasNext() {
                ...
                synchronized (ServerFinder.class) {
                    while (factories.hasNext()) {
                        final ServerFactory candidate = factories.next();
     ...
     */
    public static <T extends ServerFactory> Set<T> getAllFactories(final Class<T> type) {
     ...
     */
    public static <T extends ServerFactory> Set<T> getAvailableFactories(final Class<T> type) {
     ...
     */
    public static synchronized ServerFactory getFactoryById(final String identifier) {
    ...
    /**
     * Creates a {@link Server} instance for the given map of parameter values. This method iterates
     ...
     */
    public static Server open(final Map<String, Serializable> parameters) throws DataStoreException {
        ArgumentChecks.ensureNonNull("parameters", parameters);
        return open(null, parameters);
    }

    /**
     * Creates a {@link Server} instance for the given parameters group. This method iterates over
     ...
     * @throws DataStoreException If a factory is found but can't create the server.
     */
    public static Server open(final ParameterValueGroup parameters) throws DataStoreException {
        ArgumentChecks.ensureNonNull("parameters", parameters);
     ...
     */
    private static synchronized Server open(final ParameterValueGroup parameters,
