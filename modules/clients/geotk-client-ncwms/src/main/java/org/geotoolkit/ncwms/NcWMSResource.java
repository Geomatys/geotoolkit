 ...
 * @module
 */
public class NcWMSResource extends WMSResource{
    ...
    public NcWMSResource(NcWebMapClient server, GenericName name) {
        super(server, name);
    }

    public NcWMSResource(NcWebMapClient server, String... layers) {
        super(server, layers);
    }
