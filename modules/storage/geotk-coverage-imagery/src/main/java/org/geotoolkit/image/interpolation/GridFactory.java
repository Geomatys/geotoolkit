 ...
 * The semantic of <cite>Java Advanced Imaging</cite> {@code Resample} operation is to apply the
 * transforms as below:
 * <p>
 * <ul>
...
public class GridFactory {
     ...
     *        this factory.
     */
    public GridFactory(final double tolerance) {
     ...
     */
    public Object create(final MathTransform2D transform, final Rectangle domain)
            throws TransformException
    {
        ...
        final double[] warpPositions = new double[((xNumCells+1) * (yNumCells+1)) << 1];
        ...
        /*
         * Note: The 0.5 offset is handled by precedently mathtransform concatenation
         * effectuate by user at resample implementation, so we don't need to apply it ourself in 'gridPositions'.
         */
