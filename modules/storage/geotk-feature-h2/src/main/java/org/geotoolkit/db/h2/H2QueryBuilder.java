 ...
 */
public class H2QueryBuilder extends SQLQueryBuilder{

    public H2QueryBuilder(DefaultJDBCFeatureStore store) {
        super(store);
    }
    ...
    public String selectSQL(final FeatureType featureType, final Query query) throws SQLException, DataStoreException {
        ...
        //search version date
        final H2VersionControl versionControl;
        try{
            versionControl = (H2VersionControl) store.getVersioning(featureType.getName());
            if(vlabel!=null){
