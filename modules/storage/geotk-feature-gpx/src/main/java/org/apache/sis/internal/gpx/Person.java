...
public class Person implements Party, Contact, Address, Responsibility {
    ...
    public Collection<Contact> getContactInfo() {
        return Collections.singleton((Contact)this);
    }
    ...
    public Collection<Address> getAddresses() {
        return Collections.singleton((Address)this);
    }
    ...
    public Collection<OnlineResource> getOnlineResources() {
        if (link!=null) {
            return Collections.singleton((OnlineResource)new DefaultOnlineResource(link));
        }
        return Collections.emptyList();
    }
    ...
    public Collection<Party> getParties() {
        return Collections.singleton((Party)this);
    }
