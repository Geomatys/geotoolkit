 ...
 */
public abstract class TreeTestShape {

    protected final Tree tree;
    protected final List<Shape> lData = new ArrayList<Shape>();

    public TreeTestShape(Tree tree) throws TransformException {
     ...
     */
    protected void queryOnBorderTest() throws TransformException {
     ...
     */
    protected void queryAllTest() throws TransformException {
