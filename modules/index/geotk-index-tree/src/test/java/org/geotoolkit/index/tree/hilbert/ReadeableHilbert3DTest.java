...
/**
 * Create a generic HilbertRTree Test suite where Tree is store on hard drive in 3D Cartesian space.<br/>
 * Test is effectuate with file already filled by tree architecture.
 *
 * @author Remi Marechal (Geomatys).
 * @see DefaultEngineeringCRS#CARTESIAN_3D
 */
public final class ReadeableHilbert3DTest extends ReadeableHilbertRTreeTest {

    /**
     * Create a generic HilbertRTree Test suite with file already filled by tree architecture in 3D cartesian space.
     * 
     * @param crs
     ...
     */
    public ReadeableHilbert3DTest() throws StoreIndexException, IOException, ClassNotFoundException {
