...
//	assertTrue(results.contains("point 5"));
    ...
    public void QueryAndSpatialFilterTest() throws Exception {
        ...
        //we perform a lucene query
        Analyzer analyzer    = new ClassicAnalyzer(org.apache.lucene.util.Version.LUCENE_46);
        QueryParser parser  = new QueryParser(org.apache.lucene.util.Version.LUCENE_46, "metafile", analyzer);
        ...
        analyzer      = new ClassicAnalyzer(org.apache.lucene.util.Version.LUCENE_46);
        parser        = new QueryParser(org.apache.lucene.util.Version.LUCENE_46, "metafile", analyzer);
