...
/**
 * Create a generic BasicRTree Test suite where Tree architecture is stored into byte array in 3D Cartesian space.
 *
 * @author Remi Marechal (Geomatys).
 * @see PredefinedCRS#CARTESIAN_3D
 * @see TreeAccessByteArray
 */
public final class WritableChannelAccessBasic3DTest extends WritableChannelAccessBasicTest {
