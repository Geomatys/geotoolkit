...
import org.geotoolkit.coverage.geotiff.IIOMetadataAdpaters.GeoKeyEntry;
...
public final class GeoTiffException extends IOException {
    ...
    public String getMessage() {
        ...
        if (metadata != null) {
            ...
            message.println("NOT AVAILABLE");        // do the model tie point tags
        }
        ...
        if (metadata != null) {
            ...
            message.println("NOT AVAILABLE");        // do the transformation tag
        }
        ...
        if (t != null) {
            t.printStackTrace(message);        // close and return
        }
        message.close();
