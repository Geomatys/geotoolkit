...
public class NetcdfReadParam extends SpatialImageReadParam {
    ...
    /**
     * Returns the dimensions assigned to bands. This method returns the values given
     * to the last call to {@link #setBandDimensionTypes}, or {@code null} if none.
     *
     * @return The dimensions assigned to bands.
     */
     ...
     *
     * @param types The types of dimension to assign to bands.
     */
     ...
     *
     * @param axis The axis type (typically {@linkplain AxisType#Height height} or {@linkplain AxisType#Time time}).
    ...
    public void setSliceIndice(final AxisType dimension, final int indice) {
        if (indice < 0) {
            throw new IllegalArgumentException(Errors.format(Errors.Keys.ILLEGAL_ARGUMENT_$2, "indice", indice));
        }
