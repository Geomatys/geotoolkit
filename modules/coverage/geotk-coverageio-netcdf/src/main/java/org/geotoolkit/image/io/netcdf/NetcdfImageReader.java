 ...
 */
package org.geotoolkit.image.io.netcdf;
...
scan:       while (it.hasNext()) {
            ...
            if (dodsURL != null) {
                ...
                if (dataset == null) {
                    throw new FileNotFoundException(Errors.format(
                            Errors.Keys.FILE_DOES_NOT_EXIST_$1, inputFile));
                }
            }
            if (variableNames == null) {
                /*
                ...
                variableNames = XArrays.resize(filtered, count);
            }
        }
    }
        ...
        if (false && param instanceof NetcdfReadParam) {
            ...
            if (p.isBandDimensionSet() && variable instanceof VariableEnhanced) {
                ...
                if (relative < 0 || relative == X_DIMENSION || relative == Y_DIMENSION) {
                    throw new IllegalArgumentException(Errors.format(Errors.Keys.BAD_PARAMETER_$2,
    ...
    public static class Spi extends FileImageReader.Spi {
         ...
         *   <li>{@link #pluginClassName} = {@code "org.geotoolkit.image.io.netcdf.NetcdfImageReader"}</li>
        ...
        public Spi() {
            ...
            suffixes        = SUFFIXES;
            pluginClassName = "org.geotoolkit.image.io.netcdf.NetcdfImageReader";
