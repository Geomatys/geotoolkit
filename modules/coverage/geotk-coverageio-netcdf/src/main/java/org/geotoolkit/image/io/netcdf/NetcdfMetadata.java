...
public class NetcdfMetadata extends GeographicMetadata {
     ...
     * coordinate system, but this limitation may be revisited in a future Geotoolkit version.
     *
    ...
    public void addCoordinateSystem(final CoordinateSystem cs) {
         ...
         * (longitude, latitude, depth, time) order in Geotoolkit referencing framework.
         */
    ...
    public void addCoordinateAxis(final CoordinateAxis axis) {
        ...
        if (directionCode != null) {
            ...
            if (offset >= 0) {
                ...
                if (unitsDirection.equalsIgnoreCase(opposite)) {
                    warning("addCoordinateAxis", Errors.Keys.INCONSISTENT_AXIS_ORIENTATION_$2,
        ...
        if (AxisType.Time.equals(type)) {
            ...
            Date epoch = null;
            if (origin != null) {
                origin = Strings.trimFractionalPart(origin);
    ...
    private <T> T parse(final AxisType type, String value, final Class<T> expected, final String caller) {
        ...
        format.setLogger("org.geotoolkit.image.io.netcdf");
