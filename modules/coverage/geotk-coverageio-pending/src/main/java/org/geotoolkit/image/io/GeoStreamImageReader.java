 ...
 */
@Deprecated
public abstract class GeoStreamImageReader extends GeographicImageReader {
    /**
     ...
     */
    protected GeoStreamImageReader(final ImageReaderSpi provider) {
        super(provider);
    }
                         ...
                         final boolean ignoreMetadata)
    {
        ...
        if (input instanceof ImageInputStream) {
            try {
                ...
                streamOrigin = 0;
                Logging.unexpectedException(LOGGER, GeoStreamImageReader.class, "setInput", exception);
            }
        }
    }
    ...
    /**
     * Restores the {@code GeoStreamImageReader} to its initial state. If an input stream were
    ...
    /**
     * Service provider interface (SPI) for {@link GeoStreamImageReader}s.
     *
     * @author Martin Desruisseaux (IRD)
     * @version 3.00
     *
    ...
    public static abstract class Spi extends ImageReaderSpi {
        /**
         * List of legal input types for {@link GeoStreamImageReader}.
         */
        ...
        /**
         * Constructs a quasi-blank {@code GeoStreamImageReader.Spi}. It is up to the subclass to
