...
import org.geotoolkit.image.io.metadata.Parameter;
...
public class MetadataReader {
    ...
    public synchronized GeographicBoundingBox getGeographicBoundingBox() throws MetadataException {
        ...
        try {
            box = new DefaultGeographicBoundingBox(getEnvelope());
    ...
    public String toString() {
        ...
        try {
            ...
            buffer.write(DefaultGeographicBoundingBox.toString(box, "DD°MM'SS\"", null));
            buffer.write(lineSeparator);
        ...
        try {
            ...
            table.nextColumn();
            table.write(Trees.toString(Trees.xmlToSwing(
