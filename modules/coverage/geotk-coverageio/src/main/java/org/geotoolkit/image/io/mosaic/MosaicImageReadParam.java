 ...
 * }
 *
 * <b>Rational:</b> the {@linkplain TileManager tile manager} will select the {@linkplain Tile
...
public class MosaicImageReadParam extends ImageReadParam {
    ...
    /**
     * If {@code true}, the {@linkplain MosaicImageReader mosaic image reader} will be allowed
    ...
    /**
     * Returns {@code true} if the {@linkplain MosaicImageReader mosaic image reader} is allowed
    ...
    /**
     * Sets whatever the {@linkplain MosaicImageReader mosaic image reader} will be allowed to
