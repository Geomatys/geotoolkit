 ...
 * results. This is used during testings and assertions only. For this reasons, comparison
...
final class ComparedTileManager extends TileManager {
    ...
    @Override
    public int hashCode() {
        return (int) serialVersionUID ^ (first.hashCode() + 31 * second.hashCode());
    }
     ...
     * @return If the given object is equal to this manager.
     */
    @Override
