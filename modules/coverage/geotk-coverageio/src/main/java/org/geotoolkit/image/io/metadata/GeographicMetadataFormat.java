 ...
 * See the {@linkplain org.geotoolkit.image.io.metadata package javadoc} for a list of departures
 * from the standard.
 *
...
public class GeographicMetadataFormat extends IIOMetadataFormatImpl {
     ...
     */
    public static final String FORMAT_NAME = "geotoolkit_coverage_1.0";
     ...
     *
     * @return The default format instance.
     */
