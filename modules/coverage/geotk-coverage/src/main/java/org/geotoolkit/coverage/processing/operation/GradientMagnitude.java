 ...
 *       of latitude and longitude), the units are <strong>metres/degree</strong>.</LI>
...
public class GradientMagnitude extends OperationJAI {
    ...
    /**
     * Applies the operation on grid coverage. The default implementation looks for kernels specified
     * in the {@linkplain org.geotoolkit.coverage.processing.OperationJAI.Parameters#parameters
