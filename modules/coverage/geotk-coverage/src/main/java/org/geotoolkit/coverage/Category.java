 ...
 * ranging from -2 to 35&deg;C, and three qualitative categories for cloud, land and ice.
 * <p>
...
public class Category implements Serializable {
     ...
     * offset}&nbsp;+&nbsp;{@linkplain GridSampleDimension#getScale()
     * scale}&times;</code><var>s</var></blockquote>
     *
     * @param name
     *          The category name as a {@link String} or {@link InternationalString} object.
     * @param colors
                    ...
                    final double         offset) throws IllegalArgumentException
    {
        ...
        if (Double.isNaN(scale) || Double.isInfinite(scale)) {
            throw new IllegalArgumentException(Errors.format(Errors.Keys.BAD_COEFFICIENT_$2, "scale", scale));
        }
        if (Double.isNaN(offset) || Double.isInfinite(offset)) {
            throw new IllegalArgumentException(Errors.format(Errors.Keys.BAD_COEFFICIENT_$2, "offset", offset));
        }
    }
