...
public class CalendarEraAdapter extends PropertyType<CalendarEraAdapter, CalendarEra>{
     ...
     */
    @XmlElement(name = "TimeCalendarEra", namespace = Namespaces.GML)
    public DefaultCalendarEra getElement() {
        return DefaultCalendarEra.castOrCopy(metadata);
    }
     ...
     */
    @Override
    protected CalendarEraAdapter wrap(CalendarEra cE) {
        return new CalendarEraAdapter(cE);
    }

    /**
     * Invoked by JAXB at unmarshalling time for storing the result temporarily.
     *
     * @param calendarEra The unmarshalled element.
     */
    public void setElement(final DefaultCalendarEra calendarEra) {
        metadata = calendarEra;
    }
}
