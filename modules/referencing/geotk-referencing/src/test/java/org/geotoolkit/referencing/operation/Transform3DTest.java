...
public final class Transform3DTest {
    ...
    public void testProjectedToGeocentric() throws FactoryException, TransformException {
        ...
        final CSFactory                  csFactory = AuthorityFactoryFinder.getCSFactory                 (hints);
        final CRSFactory                crsFactory = AuthorityFactoryFinder.getCRSFactory                (hints);
        final DatumFactory            datumFactory = AuthorityFactoryFinder.getDatumFactory              (hints);
        final MathTransformFactory       mtFactory = AuthorityFactoryFinder.getMathTransformFactory      (hints);
        final CoordinateOperationFactory opFactory = AuthorityFactoryFinder.getCoordinateOperationFactory(hints);
