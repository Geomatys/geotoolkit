...
public final strictfp class GeographicTest extends ReferencingTestBase {
    /**
     * Tests the {@link DefaultGeographicCRS#shiftLongitudeRange(boolean)} method.
     */
    @Test
    public void testShiftLongitudeRange() {
        ...
        assertSame("Expected a no-op.", crs,  crs.shiftLongitudeRange(false));
        final DefaultGeographicCRS shifted =  crs.shiftLongitudeRange(true);
        ...
        assertSame("Expected the original CS.", crs,     shifted.shiftLongitudeRange(false));
        assertSame("Expected cached instance.", shifted, crs    .shiftLongitudeRange(true));
    }
}
