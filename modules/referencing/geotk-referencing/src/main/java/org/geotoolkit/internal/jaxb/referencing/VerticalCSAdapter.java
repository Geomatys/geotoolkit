...
public final class VerticalCSAdapter extends MetadataAdapter<VerticalCSAdapter,VerticalCS> {
     ...
     */
    private VerticalCSAdapter() {
    }

    /**
     * Wraps a VerticalCS value with a {@code gml:VerticalCS} element at marshalling-time.
     *
    ...
    /**
     * Returns the Vertical CS value wrapped by a {@code gml:VerticalCS} element.
     *
