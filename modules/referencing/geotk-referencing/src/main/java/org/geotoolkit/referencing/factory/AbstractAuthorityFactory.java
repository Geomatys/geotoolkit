...
public abstract class AbstractAuthorityFactory extends ReferencingFactory implements AuthorityFactory {
    ...
    /**
     * Constructs a new authority factory which is a wrapper around the given one.
     */
    AbstractAuthorityFactory(final AbstractAuthorityFactory factory) {
     ...
     */
    protected AbstractAuthorityFactory(final Hints userHints) {
        nameFactory = FactoryFinder.getNameFactory(userHints);
        hints.put(Hints.NAME_FACTORY, nameFactory);
    }
     ...
     * wrappers are {@link CachingAuthorityFactory} and {@link TransformedAuthorityFactory}.
     * <p>
     ...
     * {@linkplain org.geotoolkit.referencing.operation.AuthorityBackedFactory backed by an authority}
    ...
    private NoSuchAuthorityCodeException noSuchAuthorityCode(final Class<?> type,
            final String code, final ClassCastException cause)
    {
