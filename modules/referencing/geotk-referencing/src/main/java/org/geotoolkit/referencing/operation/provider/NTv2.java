...
public class NTv2 extends MathTransformProvider {
     ...
     */
    public static final ParameterDescriptor<String> DIFF_FILE = new DefaultParameterDescriptor<String>(
    ...
    protected MathTransform createMathTransform(final ParameterValueGroup values) throws FactoryException {
        return new NTv2Transform(Parameters.stringValue(DIFF_FILE, values));
    }
}
