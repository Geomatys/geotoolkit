...
public class MockDivideDescriptor extends AbstractProcessDescriptor{
    ...
    public static final ProcessDescriptor INSTANCE = new MockDivideDescriptor();

    private MockDivideDescriptor() {
    ...
    public Process createProcess(final ParameterValueGroup input) {
        return new DivideProcess(this, input);
    }

    public class DivideProcess extends AbstractProcess {

        public DivideProcess(final ProcessDescriptor descriptor, final ParameterValueGroup input) {
