 ...
 * @module pending
 */
public class TouchesDescriptor extends AbstractProcessDescriptor{
        
    /**Process name : touches */
    ...
    public static final ParameterDescriptor<Boolean> RESULT =
            new DefaultParameterDescriptor("result", "Touches result", Boolean.class, null, true);
