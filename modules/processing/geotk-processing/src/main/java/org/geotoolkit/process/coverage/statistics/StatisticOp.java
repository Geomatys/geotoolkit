...
public class StatisticOp extends Static {
     ...
     * @deprecated use {@link org.geotoolkit.process.coverage.statistics.Statistics#analyse(org.geotoolkit.coverage.io.GridCoverageReader, int, boolean)}
     */
     ...
     * @return A Map with two Entry. 
     * Each Entry have a name ("min", "max") and values are an double[] for each bands.
     * @deprecated use {@link org.geotoolkit.process.coverage.statistics.Statistics#analyse(java.awt.image.RenderedImage, boolean)}
     */
