...
public class ToRadianTest extends AbstractProcessTest {
    ...
    @Test
    public void testToRadian() throws NoSuchIdentifierException, ProcessException{

        // Inputs first
        final double first = 24.64;

        // Process
        final ProcessDescriptor desc = ProcessFinder.getProcessDescriptor(GeotkProcessingRegistry.NAME,"math:toRadian");
