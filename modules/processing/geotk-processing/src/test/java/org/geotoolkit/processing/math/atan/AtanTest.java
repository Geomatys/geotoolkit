...
public class AtanTest extends AbstractProcessTest {
    ...
    @Test
    public void testAtan() throws NoSuchIdentifierException, ProcessException{

        // Inputs first
        final double first = 0.64;

        // Process
        final ProcessDescriptor desc = ProcessFinder.getProcessDescriptor(GeotkProcessingRegistry.NAME,"math:atan");
