 ...
 */
public class OverlapsTest extends AbstractProcessTest {
    ...
    public void testOverlaps() throws NoSuchIdentifierException, ProcessException {
        ...
        // Process
        final ProcessDescriptor desc = ProcessFinder.getProcessDescriptor(GeotkProcessingRegistry.NAME,"jts:overlaps");
