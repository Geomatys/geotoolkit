...
import static org.geotoolkit.process.coverage.kriging.Intersections.ACCEPT_NEIGHBOR_ON_SAME_LINE;
...
nextPoint:  for (int pointId=-2; pointId<pointIdStop; pointId++) {
                ...
                switch (intNeighbor - intSearched) {
                    ...
                    case 1: {
                        ...
                        if ((ACCEPT_NEIGHBOR_ON_SAME_LINE && gridLineId == 0) || neighbor.ordinate == intNeighbor) {
