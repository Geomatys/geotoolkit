 ...
 * @module
 */
public class Resample2Descriptor extends AbstractProcessDescriptor {
     ...
     */
    public static final ProcessDescriptor INSTANCE = new Resample2Descriptor();

    private Resample2Descriptor() {
    ...
    public Process createProcess(ParameterValueGroup input) {
        return new Resample2Process(input);
    }
