...
public class ZipUtilities {
    ...
    private static void zipCore(final ZipOutputStream zout, final int method, final int level, final String entryPath, final Object... resources)
        ...
        for (int i = 0; i < resources.length; i++) {
            ZipEntry entry = new ZipEntry(entryPath + getFileName(resources[i]));
            if (stored) {
    ...
    public static void main(String[] args) throws IOException {
       ...
       // ZipUtilities.zip("/home/samuel/Bureau/test.zip", ZipOutputStream.DEFLATED, 9, null, new File("/home/samuel/Bureau/test"));
