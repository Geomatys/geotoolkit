...
import static org.geotoolkit.data.shapefile.ShpFileType.SHP_XML;
...
public class ShapefileDataStore extends AbstractFileDataStore {
    ...
    protected org.geotoolkit.data.FIDFeatureReader createFeatureReader(String typeName,
        ...
        return new org.geotoolkit.data.FIDFeatureReader(reader,
     ...
     *                 DOCUMENT ME!
     */
    protected JTSEnvelope2D getBounds() throws DataSourceException {
        // This is way quick!!!
