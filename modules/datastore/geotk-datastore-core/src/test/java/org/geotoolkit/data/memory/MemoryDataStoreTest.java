...
public class MemoryDataStoreTest extends DataTestCase {
    ...
    public void testGetFeatureSourceRoad() throws IOException {
        ...
        builder.setTypeName(road.getName());
    ...
    public void testFeatureEvents() throws Exception {
        FeatureStore<SimpleFeatureType, SimpleFeature> store1 = (FeatureStore<SimpleFeatureType, SimpleFeature>) data.getFeatureSource(roadFeatures[0].getFeatureType().getTypeName());
        FeatureStore<SimpleFeatureType, SimpleFeature> store2 = (FeatureStore<SimpleFeatureType, SimpleFeature>) data.getFeatureSource(roadFeatures[0].getFeatureType().getTypeName());
