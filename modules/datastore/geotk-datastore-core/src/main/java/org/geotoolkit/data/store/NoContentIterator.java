...
public class NoContentIterator implements Iterator<SimpleFeature> {
    ...
    private Throwable origionalProblem;

    public NoContentIterator(final Throwable t) {
        origionalProblem = t;
    }
    ...
    public SimpleFeature next() {
        ...
        final NoSuchElementException cantFind = new NoSuchElementException("Could not aquire feature:" + origionalProblem);
