...
public class ContentState {
     ...
     */
    public ContentState(final ContentEntry entry) {
        this.entry = entry;
     ...
     */
    public final void addListener(final FeatureListener listener) {
     ...
     */
    public final void removeListener(final FeatureListener listener) {
     ...
     * @param event
     */
    public final void fireFeatureEvent(final FeatureEvent event) {
        ...
        for (FeatureListener listener : listeners) {
            try {
                ...
                this.entry.dataStore.getLogger().log(Level.WARNING, "Problem issuing batch feature event " + event, t);
            }
        }
    }
    ...
    public final void fireBatchFeatureEvent(final boolean isCommit) {
        ...
        for (FeatureListener listener : listeners) {
            try {
                ...
                this.entry.dataStore.getLogger().log(Level.WARNING, "Problem issuing batch feature event " + batchFeatureEvent, t);
            }
        }
