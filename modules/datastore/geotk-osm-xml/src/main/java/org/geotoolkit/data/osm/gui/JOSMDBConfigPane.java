...
public class JOSMDBConfigPane extends javax.swing.JPanel {
    ...
    public Map<String,Serializable> getDBConnectionParameters(){
        ...
        params.put(PostgresFeatureStoreFactory.HOST.getName().getCode(), guiHost.getText());
        params.put(PostgresFeatureStoreFactory.PORT.getName().getCode(), Integer.parseInt(guiPort.getText()));
        params.put(PostgresFeatureStoreFactory.SCHEMA.getName().getCode(), guiSchema.getText());
        params.put(PostgresFeatureStoreFactory.DATABASE.getName().getCode(), guiDatabase.getText());
        params.put(PostgresFeatureStoreFactory.USER.getName().getCode(), guiUser.getText());
        params.put(PostgresFeatureStoreFactory.PASSWORD.getName().getCode(), new String(guiPassword.getPassword()));
        return params;
    }
