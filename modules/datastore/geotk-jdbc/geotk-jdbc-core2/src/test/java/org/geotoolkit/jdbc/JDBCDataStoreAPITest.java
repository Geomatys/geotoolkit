...
//
//        FeatureCollection<SimpleFeature> all = road.getFeatures();
...
//        assertTrue(areReferencedEnvelopesEuqal(td.roadBounds, (JTSEnvelope2D)all.getEnvelope()));
//
//        FeatureCollection<SimpleFeature> some = road.getFeatures(td.rd12Filter);
...
//        Query query = builder.buildQuery();
//
//        FeatureCollection<SimpleFeature> half = road.getFeatures(query);
...
//
//        FeatureCollection<SimpleFeature> all = river.getFeatures();
...
//            rd1Filter);
//
//        FeatureCollection<SimpleFeature> results = road.getFeatures(td.rd1Filter);
