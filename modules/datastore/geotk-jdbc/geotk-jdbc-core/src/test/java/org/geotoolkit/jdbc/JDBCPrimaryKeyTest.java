...
public abstract class JDBCPrimaryKeyTest extends JDBCTestSupport {
    ...
    public void testAutoGeneratedPrimaryKey() throws DataStoreException {
        SimpleFeatureType sft = (SimpleFeatureType) featureStore.getFeatureType(nsname("auto"));
        PrimaryKey pkey = featureStore.getMetaModel().getPrimaryKey(sft.getName());

        assertEquals( 1, pkey.getColumns().size() );
        assertTrue( pkey.getColumns().get(0) instanceof AutoGeneratedPrimaryKeyColumn );
        
        FeatureCollection features = featureStore.createSession(false).getFeatureCollection(QueryBuilder.all(nsname("auto")));
        ...
        assertPrimaryKeyCanBeHidden(featureStore,sft);
    }
    
    public void testSequencedPrimaryKey() throws DataStoreException {
        SimpleFeatureType sft = (SimpleFeatureType) featureStore.getFeatureType(nsname("seq"));
        PrimaryKey pkey = featureStore.getMetaModel().getPrimaryKey(sft.getName());
        
        assertEquals( 1, pkey.getColumns().size() );
        assertTrue( pkey.getColumns().get(0) instanceof SequencedPrimaryKeyColumn );
        
        FeatureCollection features = featureStore.createSession(false).getFeatureCollection(QueryBuilder.all(nsname("seq")));
        assertPrimaryKeyValues(features, 3);
    ...
    public void testNonIncrementingPrimaryKey() throws DataStoreException {
        SimpleFeatureType sft = (SimpleFeatureType) featureStore.getFeatureType(nsname("noninc"));
        PrimaryKey pkey = featureStore.getMetaModel().getPrimaryKey(sft.getName());
        
        assertEquals( 1, pkey.getColumns().size() );
        assertTrue( pkey.getColumns().get(0) instanceof NonIncrementingPrimaryKeyColumn );
        
        FeatureCollection features = featureStore.createSession(false).getFeatureCollection(QueryBuilder.all(nsname("noninc")));
        assertPrimaryKeyValues(features, 3);
    ...
    public void testMultiColumnPrimaryKey() throws DataStoreException {
        SimpleFeatureType sft = (SimpleFeatureType) featureStore.getFeatureType(nsname("multi"));
        PrimaryKey pkey = featureStore.getMetaModel().getPrimaryKey(sft.getName());
        
        assertEquals( 2, pkey.getColumns().size() );
                
        FeatureCollection features = featureStore.createSession(false).getFeatureCollection(QueryBuilder.all(nsname("multi")));
        FeatureIterator i = features.iterator();
        ...
        features = featureStore.createSession(false).getFeatureCollection(QueryBuilder.filtered(nsname("multi"),id));
    ...
    public void testNullPrimaryKey() throws DataStoreException {
        SimpleFeatureType sft = (SimpleFeatureType) featureStore.getFeatureType(nsname("nokey"));
        assertFalse( featureStore.isWritable(nsname("nokey")));
