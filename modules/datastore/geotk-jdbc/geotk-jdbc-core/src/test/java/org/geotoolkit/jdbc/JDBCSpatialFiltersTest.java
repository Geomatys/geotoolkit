...
public abstract class JDBCSpatialFiltersTest extends JDBCTestSupport {
    ...
    public void testBboxFilter() throws Exception {
        ...
        FeatureCollection features = featureStore.createSession(false).getFeatureCollection(QueryBuilder.filtered(nsname("road"),bbox));
    ...
    public void testCrossesFilter() throws Exception {
        ...
        FeatureCollection features = featureStore.createSession(false).getFeatureCollection(QueryBuilder.filtered(nsname("road"),cs));
        checkSingleResult(features, "r2");
    }
    ...
    public void testIntersectsFilter() throws Exception {
        ...
        FeatureCollection features = featureStore.createSession(false).getFeatureCollection(QueryBuilder.filtered(nsname("road"),is));
    ...
    public void testWithinFilter() throws Exception {
        ...
        FeatureCollection features = featureStore.createSession(false).getFeatureCollection(QueryBuilder.filtered(nsname("road"),wt));
        checkSingleResult(features, "r2");
    }
    ...
    public void testDisjointFilter() throws Exception {
        ...
        FeatureCollection features = featureStore.createSession(false).getFeatureCollection(QueryBuilder.filtered(nsname("road"),dj));
        checkSingleResult(features, "r2");
    }
