...
public interface SQLDialect {
     ...
     * <p>
     * Implementations should determine the version in use.
     * </p>
     * <p>
     * This method is given a direct connection to the database, but this connection
     * should never be closed. However any statements or result sets instantiated
     ...
     * @throws SQLException
     */
    String getVersion(final String schemaName, final Connection cx) throws SQLException;
    ...
    /**
     * Complete the featureType generated by the  database model.
     *
     * @param ftb
     * @param result
     * @param name
