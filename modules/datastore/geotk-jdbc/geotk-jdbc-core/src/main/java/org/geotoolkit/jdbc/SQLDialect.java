...
//    };
     ...
     * </p>
     */
    public void encodeColumnName(final String raw, final StringBuffer sql) {
     ...
     * @param sql
     */
    public void encodeColumnType(final String sqlTypeName, final StringBuffer sql) {
     ...
     * </p>
     */
    public void encodeColumnAlias(final String raw, final StringBuffer sql) {
        sql.append(" as ");
     ...
     * </p>
     */
    public void encodeTableAlias(final String raw, final StringBuffer sql) {
        sql.append(" as ");
        encodeColumnName(raw, sql);
    }
     ...
     * </p>
     */
    public void encodeTableName(final String raw, final StringBuffer sql) {
        sql.append(ne()).append(raw).append(ne());
    }
     ...
     * </p>
     */
    public void encodeSchemaName(final String raw, final StringBuffer sql) {
        sql.append(ne()).append(raw).append(ne());
    }
     ...
     * @param tableName
     */
    public abstract void encodeGeometryEnvelope(final String tableName, final String geometryColumn, final StringBuffer sql);
     ...
     * </p>
     */
    public void encodeGeometryColumn(final GeometryDescriptor gatt, final int srid, final StringBuffer sql) {
     ...
     */
    public void encodePostColumnCreateTable(final AttributeDescriptor att, final StringBuffer sql) {
     ...
     * </p>
     */
    public void encodePostCreateTable(final String tableName, final StringBuffer sql) {
    }
