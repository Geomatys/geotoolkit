...
public class JDBCUpdateInsertFeatureWriter extends JDBCUpdateFeatureWriter {
    ...
    public JDBCUpdateInsertFeatureWriter(final String sql, final Connection cx,
            final JDBCFeatureSource featureSource, final Hints hints)
            throws SQLException, IOException
    {
        super(sql, cx, featureSource, hints);
    }
    
    public JDBCUpdateInsertFeatureWriter(final PreparedStatement ps, final Connection cx,
            final JDBCFeatureSource featureSource, final String[] attributeNames, final Hints hints)
            throws SQLException, IOException
    {
