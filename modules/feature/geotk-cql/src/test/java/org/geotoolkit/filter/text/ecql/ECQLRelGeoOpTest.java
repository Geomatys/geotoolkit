...
import org.geotoolkit.filter.function.geometry.BufferFunction;
import org.geotoolkit.filter.text.commons.CompilerUtil;
import org.geotoolkit.filter.text.commons.Language;
import org.geotoolkit.filter.text.cql2.CQLRelGeoOpTest;
...
public class ECQLRelGeoOpTest extends CQLRelGeoOpTest {
    protected static final FilterFactory FILTER_FACTORY = FactoryFinder.getFilterFactory(null);
    ...
    public void functionDwithinGeometry() throws Exception{
        ...
        Assert.assertTrue(distOp.getExpression1() instanceof BufferFunction);
    ...
    public void functionDwithinFunction() throws Exception{
        ...
        Assert.assertTrue(distOp.getExpression2() instanceof BufferFunction);
    ...
    public void functionBeyondFunction() throws Exception {
        ...
        Assert.assertTrue(expr1 instanceof BufferFunction);

        Expression expr2 =  beyondFilter.getExpression2();
        Assert.assertTrue(expr2 instanceof BufferFunction);
    }
}
