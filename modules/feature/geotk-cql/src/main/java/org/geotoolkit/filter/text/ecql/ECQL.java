...
public class ECQL {
    ...
    public static Filter toFilter(final String ecqlPredicate) throws CQLException {
        return toFilter(ecqlPredicate, null);
    }
    ...
    public static Filter toFilter(final String ecqlPredicate, final FilterFactory filterFactory)
            throws CQLException
    {
        return CompilerUtil.parseFilter(ecqlPredicate, new ECQLCompilerFactory(), filterFactory);
    }
    ...
    {
        return CompilerUtil.parseExpression(ecqlExpression, new ECQLCompilerFactory(), filterFactory);
    }
