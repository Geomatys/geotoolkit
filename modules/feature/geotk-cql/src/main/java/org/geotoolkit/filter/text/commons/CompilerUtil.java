...
final public class CompilerUtil {
     ...
     * @throws CQLException
     */
    static final public Filter parseFilter(final Language language, final String predicate,
                                           final FilterFactory filterFactory) throws CQLException
    {
        ...
        final ICompiler compiler = CompilerFactory.makeCompiler(language, predicate, filterFactory);
    ...
    static final public Filter parseFilter(final Language language, final String predicate) throws CQLException {
        ...
        return parseFilter(language, predicate, null);
    }
     ...
     * @throws CQLException
     */
    static final public Expression parseExpression(final Language language, final String predicate,
                                                   final FilterFactory filterFactory) throws CQLException
    {
    ...
    static final public Expression parseExpression(final Language language, final String predicate)
                                                                                throws CQLException
    {
        return parseExpression(language, predicate, null);
    }
     ...
     * @throws CQLException
     */
    public static List<Filter> parseFilterList(final Language language, final String predicate,
            final FilterFactory filterFactory) throws CQLException
    {
    ...
    public static List<Filter> parseFilterList(final Language language, final String predicate)
            throws CQLException
    {
        return parseFilterList(language, predicate, null);
    }
     ...
     * @throws CQLException
     */
    public static Expression parseExpression(final String source, final AbstractCompilerFactory compilerFactory,
            final FilterFactory filterFactory) throws CQLException
    {
        final ICompiler compiler = compilerFactory.makeCompiler(source, filterFactory);
        compiler.compileExpression();
        return compiler.getExpression();
    }
    ...
    public static List<Filter> parseFilterList(
            ...
            final FilterFactory filterFactory) throws CQLException
    {
        final ICompiler compiler = compilerFactory.makeCompiler(predicateSequence, filterFactory);
        compiler.compileFilterList();
        return compiler.getFilterList();
    }
}
