...
public class CQLException extends ParseException {
    ...
    private final IToken currentToken;
     ...
     */
    public CQLException(final String message, final IToken token, final Throwable cause,
    ...
    public String getMessage() {
        String message = super.getMessage() + ". Parsing : " + this.cqlSource + ".";
        if (currentToken != null) {
            message += " Current Token : \"" + this.currentToken.toString()+ "\"";
            return message;
        }
        return message;
    }
