...
public interface FeatureStore<T extends FeatureType, F extends Feature> extends FeatureSource<T, F> {
    ...
    /**
     * Adds all features from the passed feature reader to the datasource.
     * <p>
     ...
     */
    List<FeatureId> addFeatures(FeatureReader<T, F> reader) throws IOException;
     ...
     */
    void updateFeatures(AttributeDescriptor[] type, Object[] value, Filter filter) throws IOException;
