...
public class NumInteriorRingFunction extends AbstractFunction {

    public NumInteriorRingFunction(final Expression expression) {
        super(GeometryFunctionFactory.NUM_INTERIOR_RING, new Expression[]{expression}, null);
    }
