...
public class SymDifferenceFunction extends AbstractFunction {

    public SymDifferenceFunction(final Expression expr1, final Expression expr2) {
        super(GeometryFunctionFactory.SYM_DIFFERENCE, new Expression[]{expr1,expr2}, null);
    }
