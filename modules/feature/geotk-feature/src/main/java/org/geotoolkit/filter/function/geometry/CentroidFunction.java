...
public class CentroidFunction extends AbstractFunction {

    public CentroidFunction(final Expression expression) {
        super(GeometryFunctionFactory.CENTROID, new Expression[] {expression}, null);
    }
