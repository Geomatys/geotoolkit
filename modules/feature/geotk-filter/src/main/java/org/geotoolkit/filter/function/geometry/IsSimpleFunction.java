...
public class IsSimpleFunction extends AbstractFunction {

    public IsSimpleFunction(final Expression expression) {
        super(GeometryFunctionFactory.IS_SIMPLE, new Expression[]{expression}, null);
    }
