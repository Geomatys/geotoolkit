...
public class IsRingFunction extends AbstractFunction {

    public IsRingFunction(final Expression expression) {
        super(GeometryFunctionFactory.IS_RING, new Expression[]{expression}, null);
    }
