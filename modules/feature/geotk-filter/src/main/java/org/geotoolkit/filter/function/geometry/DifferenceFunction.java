...
public class DifferenceFunction extends AbstractFunction {

    public DifferenceFunction(final Expression expr1, final Expression expr2) {
        super(GeometryFunctionFactory.DIFFERENCE, new Expression[]{expr1, expr2}, null);
    }
