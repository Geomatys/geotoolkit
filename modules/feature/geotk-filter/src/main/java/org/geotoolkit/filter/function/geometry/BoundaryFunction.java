...
public class BoundaryFunction extends AbstractFunction {

    public BoundaryFunction(final Expression expression) {
        super(GeometryFunctionFactory.BOUNDARY, new Expression[] {expression}, null);
    }
