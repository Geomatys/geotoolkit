...
public class GetGeometryNFunction extends AbstractFunction {

    public GetGeometryNFunction(final Expression expr1, final Expression expr2) {
        super(GeometryFunctionFactory.GET_GEOMETRY_N, new Expression[]{expr1,expr2}, null);
    }
