...
public class EnvelopeFunction extends AbstractFunction {

    public EnvelopeFunction(final Expression expression) {
        super(GeometryFunctionFactory.ENVELOPE, new Expression[]{expression}, null);
    }
