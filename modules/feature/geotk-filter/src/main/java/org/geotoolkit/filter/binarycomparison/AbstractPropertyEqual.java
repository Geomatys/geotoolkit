...
public abstract class AbstractPropertyEqual extends AbstractBinaryComparisonOperator<Expression,Expression> {
    ...
    public boolean evaluate(Object candidate) {
        ...
        } else if (right instanceof Literal && !(left instanceof Literal)) {
        ...
        if ((isNumeric1 && isNumeric2) || (isNumeric1 && (value2 instanceof CharSequence)) || (isNumeric2 && (value1 instanceof CharSequence))) {
            ...
            final Number n1, n2;
            try {
                n1 = isNumeric1 ? (Number) value1 : Double.valueOf(value1.toString());
                n2 = isNumeric2 ? (Number) value2 : Double.valueOf(value2.toString());
