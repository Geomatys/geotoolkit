...
public class ExteriorRingFunction extends AbstractFunction {

    public ExteriorRingFunction(final Expression expression) {
        super(GeometryFunctionFactory.EXTERIOR_RING, new Expression[]{expression}, null);
    }
