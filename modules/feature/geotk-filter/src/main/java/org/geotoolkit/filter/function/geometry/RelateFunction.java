...
public class RelateFunction extends AbstractFunction {

    public RelateFunction(final Expression expr1, final Expression expr2) {
        super(GeometryFunctionFactory.RELATE, new Expression[] {expr1, expr2}, null);
    }
