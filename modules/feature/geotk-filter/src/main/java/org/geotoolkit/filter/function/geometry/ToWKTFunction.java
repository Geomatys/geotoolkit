...
public class ToWKTFunction extends AbstractFunction {

    public ToWKTFunction(final Expression expression) {
        super(GeometryFunctionFactory.TO_WKT, new Expression[]{expression}, null);
    }
