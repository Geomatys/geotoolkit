...
public class NumPoints extends AbstractFunction {

    public NumPoints(final Expression expression) {
        super(GeometryFunctionFactory.NUM_POINTS, new Expression[]{expression}, null);
    }
