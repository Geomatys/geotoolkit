...
public class ConvexHullFunction extends AbstractFunction {

    public ConvexHullFunction(final Expression expression) {
        super(GeometryFunctionFactory.CONVEX_HULL, new Expression[]{expression}, null);
    }
