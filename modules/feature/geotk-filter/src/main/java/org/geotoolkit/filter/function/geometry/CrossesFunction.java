...
public class CrossesFunction extends AbstractFunction {

    public CrossesFunction(final Expression expr1, final Expression expr2) {
        super(GeometryFunctionFactory.CROSSES, new Expression[]{expr1, expr2}, null);
    }
