...
public class GetYFunction extends AbstractFunction {

    public GetYFunction(final Expression expression) {
        super(GeometryFunctionFactory.GET_Y, new Expression[]{expression}, null);
    }
