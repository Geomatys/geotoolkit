...
public class GeomLengthFunction extends AbstractFunction {

    public GeomLengthFunction(final Expression expression) {
        super(GeometryFunctionFactory.GEOM_LENGTH, new Expression[]{expression}, null);
    }
