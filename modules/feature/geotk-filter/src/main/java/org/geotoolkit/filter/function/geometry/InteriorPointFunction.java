...
public class InteriorPointFunction extends AbstractFunction {

    public InteriorPointFunction(final Expression expression) {
        super(GeometryFunctionFactory.INTERIOR_POINT, new Expression[]{expression}, null);
    }
