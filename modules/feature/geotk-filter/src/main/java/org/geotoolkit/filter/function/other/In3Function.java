...
public class In3Function extends AbstractFunction {

    public In3Function(Expression expr1, Expression expr2, Expression expr3, Expression expr4) {
        super("in3", new Expression[]{expr1,expr2,expr3,expr4}, null);
    }
