...
public class WorldFileImageWriter extends ImageWriterAdapter {
    ...
    public static class Spi extends ImageWriterAdapter.Spi {
         ...
         * @since 3.21
         */
        protected Spi(final String format, final String readerSpiName) throws IllegalArgumentException {
            this(format);
        ...
        public String getDescription(final Locale locale) {
            return Vocabulary.getResources(locale).getString(
                    Vocabulary.Keys.ImageCodecWithWorldFile_2, 1, Formats.getDisplayName(main));
        }
