...
public class GridGeometry implements Serializable {
     ...
     * @since 2.5
     */
    public GridGeometry(final GridGeometry other) {
        if (other instanceof GridGeometry) {
            // Uses this path when possible in order to accept null values.
            final GridGeometry general = (GridGeometry) other;
     ...
     * @since 2.2
     */
    public GridGeometry(final GridExtent  extent,
     ...
     * @since 2.5
     */
    public GridGeometry(final PixelInCell   anchor,
                               final MathTransform gridToCRS,
     ...
     */
    GridGeometry(final GridExtent extent,
                        final Envelope  envelope,
