...
final class LookupTableFactory extends Static {
    ...
    /**
     * Creates a new objet to use as a key in the {@link #pool}.
     *
     ...
     */
    public static LookupTableJAI create(final int sourceType, final int targetType,
            final MathTransform1D[] transforms) throws TransformException
    {
        /*
    ...
    @Override
    public int hashCode() {
        return sourceType + 31*targetType + Arrays.hashCode(transforms);
    }
