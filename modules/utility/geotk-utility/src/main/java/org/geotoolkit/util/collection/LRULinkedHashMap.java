 ...
 * @module
 *
 * @deprecated This class is trivial to derive from {@link LinkedHashMap}. Users should do
 *             that themself in order to gain more control on the eviction policy.
 */
@Deprecated
    ...
    private static void checkMaximumSize(final int maximumSize) throws IllegalArgumentException {
        if (maximumSize <= 0) {
            throw new IllegalArgumentException(Errors.format(
                    Errors.Keys.NOT_GREATER_THAN_ZERO_$1, maximumSize));
        }
    }
