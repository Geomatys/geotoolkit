...
/**
 * Annotates immutable classes. The sole purpose of this annotation is to replace the
 * "<cite>This class is immutable</cite>" sentence that would be otherwise copied in
 * class javadoc.
 * <p>
