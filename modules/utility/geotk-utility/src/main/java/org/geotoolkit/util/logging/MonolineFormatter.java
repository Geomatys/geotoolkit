...
loop:   for (int i=0; ; i++) {
     ...
     *       names are package names, but this is not mandatory neither enforced.</p></li>
     *
     *   <li><p>{@code "long"} for the full logger or class name, or {@code "short"} for only
    ...
    /**
     * Interpolates the color for the given level. If there is no color specified explicitly
     * for the given color, returns the color of the first level below the given one for which
