...
public final class ShapeUtilities {
     ...
     * <p>
     * <ul>
     *   <li>{@code result} is a point on the {@code (x1,y1)-(x2,y2)} line segment. It is located
     *       between the {@code (x1,y1)} and {@code (x2,y2)} ending points of that line segment.</li>
     *   <li>The distance between the {@code result} point and the given {@code (x,y)} point is
     *       the shortest distance among the set of points meeting the previous condition.</li>
     * </ul>
     *
     ...
     * If no result point meets those conditions, then this method returns {@code null}.
     * If two result points meet those conditions, then this method returns the point
     * which is the closest to {@code (x1,y1)}.
     *
     * @param  x1 <var>x</var> value of the first point on the line.
     * @param  y1 <var>y</var> value of the first point on the line.
     * @param  x2 <var>x</var> value of the last  point on the line.
     ...
     *         ends at {@code P2}. If two points are too close or if the tree points are colinear,
     ...
     *       in mathematic school book.</li>
     *   <li>A value of {@code false} means that the <var>x</var> axis must be parallel to the
     *       line segment joining the {@code (x0,y0)} and {@code (x2,y2)} ending points.</li>
     * </ul>
     * <p>
     * Note that if {@code y0 == y2}, then both {@code horizontal} values produce the same result.
     *
     ...
     *         and ends at {@code (x2,y2)}. If two points are too close or if the tree points are
    ...
    public static QuadCurve2D fitParabol(final double x0, final double y0,
                                         ...
                                         final boolean horizontal)
    {
        final Point2D p = parabolicControlPoint(x0, y0, x1, y1, x2, y2, horizontal, null);
     ...
     *         computing the {@code y=ax²+bx+c} equation terms. If {@code false}, it is considered
     *         parallel to the line joining the {@code P0} and {@code P2} points.
     * @param  dest Where to store the control point, or {@code null} for creating a new one.
     ...
     *         close or if the tree points are colinear, then this method returns {@code null}.
     */
    public static Point2D parabolicControlPoint(final double x0, final double y0,
            double x1, double y1, double x2, double y2,
            final boolean horizontal, final Point2D dest)
    {
        /*
    ...
    /**
     * Returns the coordinate of the center of a circle passing by the 3 given points.
     * The distance between the returned point and any of the given
     * (<var>x</var><sub>1</sub>,<var>y</var><sub>1</sub>),
     * (<var>x</var><sub>2</sub>,<var>y</var><sub>2</sub>),
     * (<var>x</var><sub>3</sub>,<var>y</var><sub>3</sub>)
     * points will be constant; it is the circle radius.
     *
