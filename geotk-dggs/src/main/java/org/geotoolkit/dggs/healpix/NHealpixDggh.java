 ...
 */
final class NHealpixDggh extends AbstractList<DiscreteGlobalGrid> implements DiscreteGlobalGridHierarchy {
    ...
    public DiscreteGlobalGrid get(int level) {
        return new NHealpixDgg(level);
    }

    @Override
    public int size() {
        return Healpix.DEPTH_MAX;
    }
