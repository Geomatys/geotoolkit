 ...
 *             | ------------| ----------------------|--------- | ---------- | ---------- |
 *             | IDN_Node    |           -           |     -    | IDN_Node   | No change  |
 *
 *
 *
 * <p>Classe Java pour IDNNodeType complex type.
 *
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 *
 * <pre>
 * &lt;complexType name="IDNNodeType">
 *   &lt;complexContent>
...
@XmlType(name = "IDNNodeType", propOrder = {
    "shortName",
    "longName"
})
public class IDNNodeType {
