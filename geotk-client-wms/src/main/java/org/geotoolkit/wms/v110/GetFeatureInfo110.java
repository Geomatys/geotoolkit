 ...
 * @module
 */
public class GetFeatureInfo110 extends AbstractGetFeatureInfo {
     ...
     */
    public GetFeatureInfo110(final String serverURL, final ClientSecurity security){
        super(serverURL, "1.1.0", security);
    }

    public GetFeatureInfo110(final WebMapClient server, final ClientSecurity security){
