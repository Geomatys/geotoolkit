 ...
 */
public class CreateArrayDoubleValuesDescriptor extends AbstractProcessDescriptor {

    public static final String NAME = "arrays.createDoubleValues";
    public static final InternationalString ABSTRACT = new SimpleInternationalString("Create an Array of double with maximum 10 different inputs");

    public static final String INPUT_FIRST_NAME = "first";
    private static final String INPUT_FIRST_REMARKS = "First value";
    public static final ParameterDescriptor<Double> INPUT_FIRST = new ParameterBuilder()
    ...
    public static final ParameterDescriptor<Double> INPUT_SECOND = new ParameterBuilder()
    ...
    public static final ParameterDescriptor<Double> INPUT_THIRD = new ParameterBuilder()
    ...
    public static final ParameterDescriptor<Double> INPUT_FOURTH = new ParameterBuilder()
    ...
    public static final ParameterDescriptor<Double> INPUT_FIFTH = new ParameterBuilder()
    ...
    public static final ParameterDescriptor<Double> INPUT_SIXTH = new ParameterBuilder()
    ...
    public static final ParameterDescriptor<Double> INPUT_SEVENTH = new ParameterBuilder()
    ...
    public static final ParameterDescriptor<Double> INPUT_EIGHTH = new ParameterBuilder()
    ...
    public static final ParameterDescriptor<Double> INPUT_NINTH = new ParameterBuilder()
    ...
    public static final ParameterDescriptor<Double> INPUT_TENTH = new ParameterBuilder()
    ...
    public static final ProcessDescriptor INSTANCE = new CreateArrayDoubleValuesDescriptor();

    public CreateArrayDoubleValuesDescriptor() {
        super(NAME, GeotkProcessingRegistry.IDENTIFICATION, ABSTRACT, INPUT_DESC, OUTPUT_DESC);
    }

    @Override
    public Process createProcess(ParameterValueGroup input) {
        return new CreateArrayDoubleValues(this, input);
    }
