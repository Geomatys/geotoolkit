...
import static org.geotoolkit.processing.coverage.math.sum.CoverageSumDescriptor.IN_FIRST_COVERAGE;
import static org.geotoolkit.processing.coverage.math.sum.CoverageSumDescriptor.IN_SECOND_COVERAGE;
import static org.geotoolkit.processing.coverage.math.sum.CoverageSumDescriptor.OUT_COVERAGE;

/**
 * @author Quentin BIALOTA (Geomatys)
 */
public class CoverageSumProcess extends CoverageMathsAbstractProcess {

    public CoverageSumProcess(final ProcessDescriptor desc, final ParameterValueGroup parameter) {
