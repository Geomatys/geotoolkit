...
import org.geotoolkit.processing.coverage.math.sum.CoverageSumWithValueProcess;
 ...
 */
public class CoverageSubstractWithValueDescriptor extends AbstractProcessDescriptor {

    public static final String NAME = "coverage:math:substractWithValue";
    public static final InternationalString ABSTRACT = new SimpleInternationalString("Substract a Coverage with a single value");
    ...
    public static final ProcessDescriptor INSTANCE = new CoverageSubstractWithValueDescriptor();

    public CoverageSubstractWithValueDescriptor() {
    ...
    public Process createProcess(ParameterValueGroup input) {
        return new CoverageSubstractWithValueProcess(this, input);
    }
}
