...
import org.geotoolkit.processing.coverage.math.substract.CoverageSubstractProcess;
 ...
 */
public class CoverageMultiplyDescriptor extends AbstractProcessDescriptor {

    public static final String NAME = "coverage:math:multiply";
    public static final InternationalString ABSTRACT = new SimpleInternationalString("Multiply single specified band of each coverage in a result coverage");
    ...
    public static final ProcessDescriptor INSTANCE = new CoverageMultiplyDescriptor();

    public CoverageMultiplyDescriptor() {
    ...
    public Process createProcess(ParameterValueGroup input) {
        return new CoverageMultiplyProcess(this, input);
    }
}
