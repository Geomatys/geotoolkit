 ...
 */
public class CoverageDivideDescriptor extends AbstractProcessDescriptor {

    public static final String NAME = "coverage:math:divide";
    public static final InternationalString ABSTRACT = new SimpleInternationalString("Divide single specified band of each coverage in a result coverage");
    ...
    public static final ProcessDescriptor INSTANCE = new CoverageDivideDescriptor();

    public CoverageDivideDescriptor() {
    ...
    public Process createProcess(ParameterValueGroup input) {
        return new CoverageDivideProcess(this, input);
    }
}
