 ...
 */
public class CoverageSumDescriptor extends AbstractProcessDescriptor {

    public static final String NAME = "coverage:math:sum";
    public static final InternationalString ABSTRACT = new SimpleInternationalString("Sum single specified band of each coverage in a result coverage");
    ...
    public static final ProcessDescriptor INSTANCE = new CoverageSumDescriptor();

    public CoverageSumDescriptor() {
    ...
    public Process createProcess(ParameterValueGroup input) {
        return new CoverageSumProcess(this, input);
    }
}
