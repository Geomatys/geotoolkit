 ...
 */
public class CoverageMultiplyWithValueDescriptor extends AbstractProcessDescriptor {

    public static final String NAME = "coverage:math:multiplyWithValue";
    public static final InternationalString ABSTRACT = new SimpleInternationalString("Mulitply a Coverage with a single value");
    ...
    public static final ProcessDescriptor INSTANCE = new CoverageMultiplyWithValueDescriptor();

    public CoverageMultiplyWithValueDescriptor() {
    ...
    public Process createProcess(ParameterValueGroup input) {
        return new CoverageMultiplyWithValueProcess(this, input);
    }
}
