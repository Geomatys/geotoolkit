...
import org.geotoolkit.processing.coverage.math.substract.CoverageSubstractWithValueProcess;
 ...
 */
public class CoverageDivideWithValueDescriptor extends AbstractProcessDescriptor {

    public static final String NAME = "coverage:math:divideWithValue";
    public static final InternationalString ABSTRACT = new SimpleInternationalString("Divide a Coverage with a single value");
    ...
    public static final ProcessDescriptor INSTANCE = new CoverageDivideWithValueDescriptor();

    public CoverageDivideWithValueDescriptor() {
    ...
    public Process createProcess(ParameterValueGroup input) {
        return new CoverageDivideWithValueProcess(this, input);
    }
}
