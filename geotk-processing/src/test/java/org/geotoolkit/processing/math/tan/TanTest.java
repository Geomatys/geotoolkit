 ...
 */
package org.geotoolkit.processing.math.tan;
...
public class TanTest extends AbstractProcessTest {
    ...
    public void testsin() throws NoSuchIdentifierException, ProcessException{
        ...
        // Process
        final ProcessDescriptor desc = ProcessFinder.getProcessDescriptor(GeotkProcessingRegistry.NAME,"math:tan");
