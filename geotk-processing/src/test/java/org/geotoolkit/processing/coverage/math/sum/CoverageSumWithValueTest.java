 ...
 */
public class CoverageSumWithValueTest {

    @Test
    public void gridCoverageArraysTest() throws Exception{

        final ProcessDescriptor desc = ProcessFinder.getProcessDescriptor(GeotkProcessingRegistry.NAME, CoverageSumWithValueDescriptor.NAME);
        assertNotNull(desc);
        ...
        assertArrayEquals(resultPixel1, new int[]{12});
        assertArrayEquals(resultPixel2, new int[]{22});
    }
