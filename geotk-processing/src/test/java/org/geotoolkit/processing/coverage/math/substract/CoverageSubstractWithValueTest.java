 ...
 */
public class CoverageSubstractWithValueTest {

    @Test
    public void gridCoverageArraysTest() throws Exception{

        final ProcessDescriptor desc = ProcessFinder.getProcessDescriptor(GeotkProcessingRegistry.NAME, CoverageSubstractWithValueDescriptor.NAME);
        assertNotNull(desc);
